...
lexer.literals(*"const typedef struct union enum extern ufbx_abi ufbx_inline ufbx_nullable ufbx_abi ufbx_unsafe UFBX_LIST_TYPE UFBX_ENUM_REPR UFBX_FLAG_REPR UFBX_ENUM_FORCE_WIDTH UFBX_FLAG_FORCE_WIDTH UFBX_ENUM_TYPE UFBX_CONVERSION_IMPL UFBX_CONVERSION_IMPL_LIST UFBX_CONVERSION_IMPL_TO".split())
lexer.literals(*",.*[]{}()<>=-;")
