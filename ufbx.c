...
static ufbx_string ufbxi_strings[] = {
	...
	{ ufbxi_AreaLightShape, sizeof(ufbxi_AreaLightShape) - 1 },
	...
	{ ufbxi_BinormalsIndex, sizeof(ufbxi_BinormalsIndex) - 1 },
	...
	{ ufbxi_CastLight, sizeof(ufbxi_CastLight) - 1 },
	{ ufbxi_CastShadows, sizeof(ufbxi_CastShadows) - 1 },
	...
	{ ufbxi_InnerAngle, sizeof(ufbxi_InnerAngle) - 1 },
	...
	{ ufbxi_NormalsIndex, sizeof(ufbxi_NormalsIndex) - 1 },
...
ufbxi_nodiscard static int ufbxi_read_vertex_element(ufbxi_context *uc, ufbx_mesh *mesh, ufbxi_node *node,
	void *p_dst_data_void, int32_t **p_dst_index, int32_t **p_dst_by_vertex, size_t *p_num_elems, const char *data_name, const char *index_name, char data_type, size_t num_components)
{
	...
	*p_num_elems = num_elems ? num_elems : 1;
	...
	if (indices) {
		...
		if (mapping == ufbxi_ByPolygonVertex) {
			...
			ufbxi_check(ufbxi_check_indices(uc, p_dst_by_vertex, index_data, false, num_indices, mesh->num_vertices, num_elems));
			...
			*p_dst_index = (int32_t*)ufbxi_sentinel_index_zero;
			uc->max_zero_indices = ufbxi_max_sz(uc->max_zero_indices, mesh->num_vertices);
			*p_dst_by_vertex = (int32_t*)ufbxi_sentinel_index_zero;
		...
		if (mapping == ufbxi_ByPolygonVertex) {
			...
			ufbxi_check(ufbxi_check_indices(uc, p_dst_index, mesh->vertex_position.by_index, false, mesh->num_indices, mesh->num_indices, num_elems));

			// .. and use consecutive indices for `by_vertex`
			uc->max_consecutive_indices = ufbxi_max_sz(uc->max_consecutive_indices, mesh->num_vertices);
			*p_dst_by_vertex = (int32_t*)ufbxi_sentinel_index_consecutive;
...
ufbxi_nodiscard static int ufbxi_sort_blend_offsets(ufbxi_context *uc, ufbxi_blend_offset *offsets, size_t count)
{
...
ufbxi_nodiscard static int ufbxi_read_synthetic_blend_shapes(ufbxi_context *uc, ufbxi_node *node, ufbxi_element_info *info)
{
...
ufbxi_nodiscard static int ufbxi_read_mesh(ufbxi_context *uc, ufbxi_node *node, ufbxi_element_info *info)
{
	...
	// Vertex positions are always consecutive by vertex
	uc->max_consecutive_indices = ufbxi_max_sz(uc->max_consecutive_indices, mesh->num_vertices);
	mesh->vertex_position.by_vertex = (int32_t*)ufbxi_sentinel_index_consecutive;
	...
	ufbxi_for (ufbxi_node, n, node->children, node->num_children) {
		...
		if (n->name == ufbxi_LayerElementNormal) {
			...
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_normal.data, &mesh->vertex_normal.by_index, 
				&mesh->vertex_normal.by_vertex, &mesh->vertex_normal.num_values, ufbxi_Normals, ufbxi_NormalsIndex, 'r', 3));
			...
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.data ,&layer->elem.by_index,
				&layer->elem.by_vertex, &layer->elem.num_values, ufbxi_Binormals, ufbxi_BinormalsIndex, 'r', 3));
			...
			ufbxi_ignore(ufbxi_get_val1(n, "I", &layer->index));
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.data, &layer->elem.by_index,
				&layer->elem.by_vertex, &layer->elem.num_values, ufbxi_Tangents, ufbxi_TangentsIndex, 'r', 3));
			...
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_uv.data, &set->vertex_uv.by_index,
				&set->vertex_uv.by_vertex, &set->vertex_uv.num_values, ufbxi_UV, ufbxi_UVIndex, 'r', 2));
			...
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_color.data, &set->vertex_color.by_index,
				&set->vertex_color.by_vertex, &set->vertex_color.num_values, ufbxi_Colors, ufbxi_ColorIndex, 'r', 4));
		} else if (n->name == ufbxi_LayerElementVertexCrease) {
			ufbxi_check(ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_crease.data, &mesh->vertex_crease.by_index,
				&mesh->vertex_crease.by_vertex, &mesh->vertex_crease.num_values, ufbxi_VertexCrease, ufbxi_VertexCreaseIndex, 'r', 1));
...
ufbxi_nodiscard static int ufbxi_read_blend_channel(ufbxi_context *uc, ufbxi_node *node, ufbxi_element_info *info)
{
...
ufbxi_nodiscard static int ufbxi_sort_name_elements(ufbxi_context *uc, ufbx_name_element *name_elems, size_t count)
{
...
ufbxi_nodiscard static ufbx_connection_list ufbxi_find_dst_connections(ufbx_element *element, const char *prop)
{
...
ufbxi_nodiscard static ufbx_connection_list ufbxi_find_src_connections(ufbx_element *element, const char *prop)
{
	if (!prop) prop = ufbxi_empty_char;
...
ufbxi_nodiscard static int ufbxi_fetch_dst_elements(ufbxi_context *uc, void *p_dst_list, ufbx_element *element, bool search_node, const char *prop, ufbx_element_type src_type)
{
...
ufbxi_nodiscard static int ufbxi_fetch_src_elements(ufbxi_context *uc, void *p_dst_list, ufbx_element *element, bool search_node, const char *prop, ufbx_element_type dst_type)
{
	size_t num_elements = 0;
...
ufbxi_nodiscard static ufbx_element *ufbxi_fetch_dst_element(ufbx_element *element, bool search_node, const char *prop, ufbx_element_type src_type)
{
	do {
		ufbx_connection_list conns = ufbxi_find_dst_connections(element, prop);
		ufbxi_for_list(ufbx_connection, conn, conns) {
...
ufbxi_nodiscard static ufbx_element *ufbxi_fetch_src_element(ufbx_element *element, bool search_node, const char *prop, ufbx_element_type dst_type)
{
	do {
		ufbx_connection_list conns = ufbxi_find_src_connections(element, prop);
		ufbxi_for_list(ufbx_connection, conn, conns) {
...
ufbxi_nodiscard static int ufbxi_fetch_textures(ufbxi_context *uc, ufbx_material_texture_list *list, ufbx_element *element, bool search_node)
{
	size_t num_textures = 0;
...
ufbxi_nodiscard static int ufbxi_fetch_blend_keyframes(ufbxi_context *uc, ufbx_blend_keyframe_list *list, ufbx_element *element)
{
...
ufbxi_nodiscard static int ufbxi_sort_anim_props(ufbxi_context *uc, ufbx_anim_prop *aprops, size_t count)
{
...
ufbxi_nodiscard static int ufbxi_sort_skin_weights(ufbxi_context *uc, ufbx_skin_deformer *skin)
{
...
static void ufbxi_fetch_mapping_maps(ufbx_material *material, ufbx_material_map *maps, ufbx_shader *shader, const ufbxi_shader_mapping *mappings, size_t count)
{
...
ufbxi_nodiscard static int ufbxi_finalize_scene(ufbxi_context *uc)
{
...

	{
		...
		ufbxi_for_ptr_list(ufbx_mesh, p_mesh, uc->scene.meshes) {
			...
			ufbxi_patch_index_pointer(uc, &mesh->vertex_position.by_index);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_position.by_vertex);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_normal.by_index);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_normal.by_vertex);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_bitangent.by_index);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_bitangent.by_vertex);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_tangent.by_index);
			ufbxi_patch_index_pointer(uc, &mesh->vertex_tangent.by_vertex);
			...
			ufbxi_for_list(ufbx_uv_set, set, mesh->uv_sets) {
				...
				ufbxi_patch_index_pointer(uc, &set->vertex_uv.by_vertex);
				ufbxi_patch_index_pointer(uc, &set->vertex_bitangent.by_index);
				ufbxi_patch_index_pointer(uc, &set->vertex_bitangent.by_vertex);
				ufbxi_patch_index_pointer(uc, &set->vertex_tangent.by_index);
				ufbxi_patch_index_pointer(uc, &set->vertex_tangent.by_vertex);
			}

			ufbxi_for_list(ufbx_color_set, set, mesh->color_sets) {
				ufbxi_patch_index_pointer(uc, &set->vertex_color.by_index);
				ufbxi_patch_index_pointer(uc, &set->vertex_color.by_vertex);
			}
...
static ufbxi_forceinline ufbx_element *ufbxi_translate_element(ufbxi_eval_context *ec, ufbx_element *elem)
{
	return elem ? (ufbx_element*)(ec->dst_element + ((char*)elem - ec->src_element)) : NULL;
}

static ufbxi_nodiscard int ufbxi_translate_element_list(ufbxi_eval_context *ec, void *p_list)
{
...
static ufbxi_nodiscard int ufbxi_translate_anim(ufbxi_eval_context *ec, ufbx_anim *anim)
{
	...
	for (size_t i = 0; i < anim->layers.count; i++) {
		...
		layers[i].layer = (ufbx_anim_layer*)ufbxi_translate_element(ec, &layers[i].layer->element);
	}
...
static ufbxi_nodiscard int ufbxi_evaluate_imp(ufbxi_eval_context *ec)
{
	...
	ec->scene.root_node = (ufbx_node*)ufbxi_translate_element(ec, &ec->scene.root_node->element);
	...
	ufbxi_for_ptr_list(ufbx_node, p_node, ec->scene.nodes) {
		ufbx_node *node = *p_node;
		node->parent = (ufbx_node*)ufbxi_translate_element(ec, &node->parent->element);
		ufbxi_check_err(&ec->error, ufbxi_translate_element_list(ec, &node->children));

		node->attrib = ufbxi_translate_element(ec, node->attrib);
		node->mesh = (ufbx_mesh*)ufbxi_translate_element(ec, &node->mesh->element);
		node->light = (ufbx_light*)ufbxi_translate_element(ec, &node->light->element);
		node->camera = (ufbx_camera*)ufbxi_translate_element(ec, &node->camera->element);
		node->bone = (ufbx_bone*)ufbxi_translate_element(ec, &node->bone->element);
	...
	ufbxi_for_ptr_list(ufbx_camera_stereo, p_stereo, ec->scene.camera_stereos) {
		ufbx_camera_stereo *stereo = *p_stereo;
		stereo->left = (ufbx_camera*)ufbxi_translate_element(ec, &stereo->left->element);
		stereo->right = (ufbx_camera*)ufbxi_translate_element(ec, &stereo->right->element);
	}
	...
	ufbxi_for_ptr_list(ufbx_skin_cluster, p_cluster, ec->scene.skin_clusters) {
		ufbx_skin_cluster *cluster = *p_cluster;
		cluster->bone = (ufbx_node*)ufbxi_translate_element(ec, &cluster->bone->element);
	}
	...
	ufbxi_for_ptr_list(ufbx_blend_channel, p_chan, ec->scene.blend_channels) {
		...
		for (size_t i = 0; i < chan->keyframes.count; i++) {
			...
			keys[i].shape = (ufbx_blend_shape*)ufbxi_translate_element(ec, &keys[i].shape->element);
		}
	...
	ufbxi_for_ptr_list(ufbx_material, p_material, ec->scene.materials) {
		...
		material->shader = (ufbx_shader*)ufbxi_translate_element(ec, &material->shader->element);
		for (size_t i = 0; i < UFBX_NUM_MATERIAL_FBX_MAPS; i++) {
			ufbx_material_map *map = &material->fbx.maps[i];
			map->texture = (ufbx_texture*)ufbxi_translate_element(ec, &material->shader->element);
		}
	...
	ufbxi_for_ptr_list(ufbx_anim_layer, p_layer, ec->scene.anim_layers) {
		...
		for (size_t i = 0; i < layer->anim_props.count; i++) {
			...
			props[i].anim_value = (ufbx_anim_value*)ufbxi_translate_element(ec, &props[i].anim_value->element);
		}
	...
	ufbxi_for_ptr_list(ufbx_anim_value, p_value, ec->scene.anim_values) {
		ufbx_anim_value *value = *p_value;
		value->curves[0] = (ufbx_anim_curve*)ufbxi_translate_element(ec, &value->curves[0]->element);
		value->curves[1] = (ufbx_anim_curve*)ufbxi_translate_element(ec, &value->curves[1]->element);
		value->curves[2] = (ufbx_anim_curve*)ufbxi_translate_element(ec, &value->curves[2]->element);
	}
...
static ufbxi_nodiscard ufbx_scene *ufbxi_evaluate_scene(ufbxi_eval_context *ec, ufbx_scene *scene, ufbx_anim anim, double time, const ufbx_evaluate_opts *user_opts, ufbx_error *p_error)
{
	...
	ufbxi_expand_evaluate_defaults(&ec->opts);
...
static bool ufbxi_is_edge_smooth(ufbx_mesh *mesh, ufbx_topo_index *indices, int32_t index)
{
	...
	if (!mesh->edge_smoothing && !mesh->face_smoothing && mesh->vertex_normal.data) {
		int32_t twin = indices[index].twin;
		if (twin >= 0) {
			ufbx_vec3 a0 = ufbx_get_by_index_vec3(&mesh->vertex_normal, index);
			ufbx_vec3 a1 = ufbx_get_by_index_vec3(&mesh->vertex_normal, indices[index].next);
			ufbx_vec3 b0 = ufbx_get_by_index_vec3(&mesh->vertex_normal, indices[twin].next);
			ufbx_vec3 b1 = ufbx_get_by_index_vec3(&mesh->vertex_normal, twin);
...
static bool ufbxi_is_edge_split(const ufbx_vertex_attrib *attrib, ufbx_topo_index *topo, int32_t index)
{		  
	int32_t twin = topo[index].twin;
	if (twin >= 0) {
		int32_t a0 = attrib->by_index[index];
		int32_t a1 = attrib->by_index[topo[index].next];
		int32_t b0 = attrib->by_index[topo[twin].next];
		int32_t b1 = attrib->by_index[twin];
...
size_t ufbx_generate_normal_mapping(ufbx_mesh *mesh, ufbx_topo_index *indices, ufbx_topo_vertex *vertices, int32_t *normal_indices)
{
	...
	for (size_t vi = 0; vi < mesh->num_vertices; vi++) {
		...
		for (;;) {
			int32_t prev = ufbx_topo_next_vertex_edge(indices, cur);
			if (!ufbxi_is_edge_smooth(mesh, indices, cur)) start = cur;
...
void ufbx_subdivide_layer(ufbx_mesh *mesh, ufbx_vertex_attrib *result, const ufbx_vertex_attrib *layer, ufbx_topo_index *topo, ufbx_topo_vertex *topo_vertices, const ufbx_subdivide_opts *opts, ufbx_subdivision_boundary boundary)
{
	...
	for (int32_t ix = 0; ix < mesh->num_indices; ix++) {
	...
	ufbx_real *values = malloc((num_edge_values + mesh->num_faces + mesh->num_indices) * reals * sizeof(ufbx_real));
	...
	for (size_t fi = 0; fi < mesh->num_faces; fi++) {
		...
		for (uint32_t ci = 0; ci < face.num_indices; ci++) {
			...
			ufbx_real *value = layer->data + layer->by_index[ix] * reals;
	...
	// Vertex points
	for (size_t vi = 0; vi < mesh->num_vertices; vi++) {
		int32_t original_start = topo_vertices[vi].first_index;
		if (original_start < 0) continue;
		...
		while (start >= 0) {
			...
			{
				const ufbx_real *e0 = layer->data + layer->by_index[topo[start].next] * reals;
			...
			if (num_crease > 2
				...
				ufbx_real *e0 = layer->data + layer->by_index[edge_points[0]] * reals;
				ufbx_real *e1 = layer->data + layer->by_index[edge_points[1]] * reals;
	...
	for (size_t old_ix = 0; old_ix < mesh->num_indices; old_ix++) {
		...
		if (ix < 0) {
			...
			const ufbx_real *src = layer->data + layer->by_index[old_ix] * reals;
			ufbx_real *dst = vertex_values + ix * reals;
			for (size_t i = 0; i < reals; i++) dst[i] = src[i];
		}
	}

	int32_t *new_indices = malloc(mesh->num_indices * 4 * sizeof(int32_t));
	...
	ufbx_real *new_values = malloc(num_values * reals * sizeof(ufbx_real));
	memcpy(new_values, values, num_values * reals * sizeof(ufbx_real));
	free(values);

	result->data = new_values;
	result->by_index = new_indices;
	result->by_vertex = NULL;
	result->num_values = num_values;
	result->value_reals = layer->value_reals;
}

ufbx_mesh *ufbx_subdivide_mesh(ufbx_mesh *mesh, const ufbx_subdivide_opts *user_opts)
{
	...
	*result = *mesh;
	...
	result->faces = malloc(result->num_faces * sizeof(ufbx_face));

	// TODO: Calculate normals

	if (mesh->face_material) {
		result->face_material = malloc(result->num_faces * sizeof(int32_t));
	}
	if (mesh->face_smoothing) {
		result->face_smoothing = malloc(result->num_faces * sizeof(bool));
	}
	...
	for (size_t i = 0; i < mesh->num_faces; i++) {
		...
		if (mesh->face_material) {
			...
			for (size_t ci = 0; ci < face.num_indices; ci++) {
				result->face_material[fi + ci] = mat;
			}
		}
		if (mesh->face_smoothing) {
			bool flag = mesh->face_smoothing[i];
			for (size_t ci = 0; ci < face.num_indices; ci++) {
				result->face_smoothing[fi + ci] = flag;
			}
		}
		fi += face.num_indices;
	}
	...
	if (mesh->edges) {
		...
		result->edges = malloc(result->num_edges * sizeof(ufbx_edge));

		if (mesh->edge_crease) {
			result->edge_crease = malloc(result->num_edges * sizeof(ufbx_real));
		}
		if (mesh->edge_smoothing) {
			result->edge_smoothing = malloc(result->num_edges * sizeof(bool));
		}
