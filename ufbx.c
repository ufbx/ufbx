...
static ufbxi_forceinline uint8_t
ufbxi_read_u8(const char* stream)
{
  //.
  uint8_t value;
  memcpy((char*)(&value), stream, sizeof(uint8_t));

  //.
  return value;
}

static ufbxi_forceinline uint16_t
ufbxi_read_u16(const char* stream)
{
  //.
  uint16_t value;
  memcpy((char*)(&value), stream, sizeof(uint16_t));
...
ufbxi_read_u32(const char* stream)
{
  //.
  uint32_t value;
  memcpy((char*)(&value), stream, sizeof(uint32_t));
...
ufbxi_read_u64(const char* stream)
{
  //.
  uint64_t value;
  memcpy((char*)(&value), stream, sizeof(uint64_t));

  //.
  return value;
}

static ufbxi_forceinline int8_t
ufbxi_read_i8(const char* stream)
{
  //.
  int8_t value;
  memcpy((char*)(&value), stream, sizeof(int8_t));

  //.
  return value;
}

static ufbxi_forceinline int16_t
ufbxi_read_i16(const char* stream)
{
  //.
  int16_t value;
  memcpy((char*)(&value), stream, sizeof(int16_t));

  //.
  return value;
}

static ufbxi_forceinline int32_t
ufbxi_read_i32(const char* stream)
{
  //.
  int32_t value;
  memcpy((char*)(&value), stream, sizeof(int32_t));

  //.
  return value;
}

static ufbxi_forceinline int64_t
ufbxi_read_i64(const char* stream)
{
  //.
  int64_t value;
  memcpy((char*)(&value), stream, sizeof(int64_t));

  //.
  return value;
}

static ufbxi_forceinline float
ufbxi_read_f32(const char* stream)
{
  //.
  float value;
  memcpy((char*)(&value), stream, sizeof(float));
...
ufbxi_read_f64(const char* stream)
{
  //.
  double value;
  memcpy((char*)(&value), stream, sizeof(double));
