...
UFBXT_CPP_TEST(test_mesh_ptr)
{
    ...
    std::unique_ptr<ufbx_mesh, ufbx_deleter> mesh3{ufbx_subdivide_mesh(mesh, 1, nullptr, nullptr)};
    ufbxt_assert(mesh1);
    ufbxt_assert(mesh2);
    ufbxt_assert(mesh3);
}
...
UFBXT_CPP_TEST(test_line_curve_ptr)
{
    ...
    std::unique_ptr<ufbx_line_curve, ufbx_deleter> line3{ufbx_tessellate_nurbs_curve(curve, nullptr, nullptr)};
    ufbxt_assert(line1);
    ufbxt_assert(line2);
    ufbxt_assert(line3);
}
...
UFBXT_CPP_TEST(test_geometry_cache_ptr)
{
    ...
    std::unique_ptr<ufbx_geometry_cache, ufbx_deleter> cache3{ufbx_load_geometry_cache("marvelous_quad.xml", nullptr, nullptr)};
	ufbxt_assert(cache1);
}
...
UFBXT_CPP_TEST(test_anim_ptr)
{
    ...
    std::unique_ptr<ufbx_anim, ufbx_deleter> anim3{ufbx_create_anim(scene.get(), &opts, nullptr)};
    ufbxt_assert(anim1);
    ufbxt_assert(anim2);
    ufbxt_assert(anim3);
}
