...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
	{ "maya_cube_7100_binary", 16067, 15, 0, 0, 0, "total <= UFBXI_MAX_ALLOCATION_SIZE" },
	{ "blender_279_default_6100_ascii", -1, 0, 17, 0, 0, "ator->allocs_left > 1" },
	{ "maya_rotation_order_7500_binary", 23724, 15, 0, 0, 0, "total <= UFBXI_MAX_ALLOCATION_SIZE" },
	{ "blender_279_default_6100_ascii", -1, 0, 70, 0, 0, "ator->allocs_left > 1" },
	{ "blender_279_default_7400_binary", 21085, 15, 0, 0, 0, "size <= UFBXI_MAX_ALLOCATION_SIZE" },
	...
	{ "blender_279_default_7400_binary", 35, 5, 0, 0, 0, "str || length == 0" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 33, 0, "str" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 1, "uc->read_fn" },
	{ "blender_279_default_7400_binary", 35, 233, 0, 0, 0, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21377, "uc->read_fn" },
	...
	{ "blender_279_default_7400_binary", 21085, 15, 0, 0, 0, "data" },
	{ "blender_279_default_7400_binary", 25400, 2, 0, 0, 0, "header" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21209, "data" },
	{ "blender_279_default_7400_binary", 21085, 255, 0, 0, 0, "size <= uc->opts.max_array_size" },
	{ "blender_279_default_7400_binary", 21085, 15, 0, 0, 0, "arr_data" },
	{ "maya_cube_7100_binary", 16067, 15, 0, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->convert_buffer, &u..." },
	{ "blender_279_default_7400_binary", 21086, 0, 0, 0, 0, "encoded_size == decoded_data_size" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21377, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
	{ "blender_279_default_7400_binary", -1, 0, 1492, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->read_buffer, &uc->..." },
	{ "blender_279_default_7400_binary", 21081, 105, 0, 0, 0, "res == (ptrdiff_t)decoded_data_size" },
	{ "blender_279_default_7400_binary", 21086, 255, 0, 0, 0, "Bad array encoding" },
	{ "maya_cube_6100_binary", 6766, 15, 0, 0, 0, "arr_data" },
	...
	{ "blender_279_default_7400_binary", 822, 98, 0, 0, 0, "data" },
	{ "blender_279_default_7400_binary", 35, 5, 0, 0, 0, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
	{ "blender_279_default_7400_binary", 35, 233, 0, 0, 0, "ufbxi_skip_bytes(uc, encoded_size)" },
	{ "blender_279_default_7400_binary", 31, 255, 0, 0, 0, "Bad values type" },
	{ "blender_279_default_7400_binary", 66, 4, 0, 0, 0, "offset <= values_end_offset" },
	{ "blender_279_default_7400_binary", 35, 95, 0, 0, 0, "ufbxi_skip_bytes(uc, values_end_offset - offset)" },
	{ "blender_279_default_7400_binary", 58, 255, 0, 0, 0, "current_offset == end_offset" },
	{ "blender_279_default_7400_binary", 35, 93, 0, 0, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
	...
	{ "blender_279_default_6100_ascii", 0, 45, 0, 0, 0, "end == token->str_data + token->str_len - 1" },
	{ "blender_279_default_6100_ascii", 0, 46, 0, 0, 0, "end == token->str_data + token->str_len - 1" },
	{ "blender_279_default_6100_ascii", 382, 0, 0, 0, 0, "c != '\\0'" },
	{ "blender_279_default_6100_ascii", 180, 46, 0, 0, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
	{ "blender_279_default_6100_ascii", 103, 125, 0, 0, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5132, 0, 0, "name" },
	{ "blender_279_default_6100_ascii", -1, 0, 144, 0, 0, "node" },
	{ "blender_279_default_6100_ascii", -1, 0, 1625, 0, 0, "arr" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 33, 0, "ufbxi_push_string_place_str(uc, &v->s)" },
	{ "maya_cube_6100_ascii", -1, 0, 0, 560, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 272, 0, "v" },
	{ "maya_interpolation_modes_7500_ascii", -1, 0, 1168, 0, 0, "v" },
	{ "maya_auto_clamp_7100_ascii", -1, 0, 1136, 0, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 5105, 0, 0, "v" },
	{ "maya_auto_clamp_7100_ascii", -1, 0, 1121, 0, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 5106, 0, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 5107, 0, 0, "v" },
	{ "maya_cube_7100_ascii", 8935, 42, 0, 0, 0, "!in_ascii_array" },
	{ "blender_279_default_6100_ascii", 180, 42, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
	{ "maya_cube_7100_ascii", 8926, 123, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
	{ "blender_279_default_6100_ascii", 20743, 42, 0, 0, 0, "ufbxi_ascii_accept(uc, '}')" },
	{ "blender_279_default_6100_ascii", -1, 0, 5108, 0, 0, "arr_data" },
	{ "blender_279_default_6100_ascii", -1, 0, 48, 0, 0, "node->vals" },
	{ "blender_279_default_6100_ascii", 203, 123, 0, 0, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
	{ "blender_279_default_6100_ascii", -1, 0, 64, 0, 0, "node->children" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 1, "header" },
	{ "blender_279_default_6100_ascii", 0, 46, 0, 0, 0, "ufbxi_ascii_next_token(uc, &uc->ascii.token)" },
	...
	{ "blender_279_default_6100_ascii", 469, 123, 0, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5040, 0, 0, "node->children" },
	...
	{ "blender_279_default_7400_binary", 3210, 249, 0, 0, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
	{ "blender_279_default_7400_binary", -1, 0, 220, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
	{ "blender_279_default_6100_ascii", 1096, 58, 0, 0, 0, "ufbxi_get_val2(node, \"SC\", &prop->name, (char**)&type..." },
	{ "blender_279_default_7400_binary", 3830, 2, 0, 0, 0, "ufbxi_get_val_at(node, val_ix++, 'C', (char**)&subtype_..." },
	...
	{ "blender_279_default_6100_ascii", 1096, 58, 0, 0, 0, "ufbxi_read_property(uc, prop_node, prop, version)" },
	...
	{ "blender_279_default_7400_binary", 3830, 2, 0, 0, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
	{ "blender_279_default_7400_binary", -1, 0, 1345, 0, 0, "uc->templates" },
	{ "blender_279_default_6100_ascii", 20743, 125, 0, 0, 0, "data" },
	{ "blender_279_default_6100_ascii", 20877, 44, 0, 0, 0, "data->size % num_components == 0" },
	{ "blender_279_default_6100_ascii", 20778, 59, 0, 0, 0, "ufbxi_find_val1(node, ufbxi_MappingInformationType, \"C..." },
	{ "blender_282_suzanne_7400_binary", 22994, 14, 0, 0, 0, "Invalid mapping" },
	...
	{ "blender_279_default_6100_ascii", 20377, 125, 0, 0, 0, "vertices && indices" },
	{ "blender_279_default_6100_ascii", 20379, 44, 0, 0, 0, "vertices->size % 3 == 0" },
	{ "blender_279_default_6100_ascii", 20644, 125, 0, 0, 0, "index_data[mesh->num_indices - 1] < 0" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 388, 0, "edges" },
	...
	{ "blender_279_default_6100_ascii", 20377, 59, 0, 0, 0, "ix < mesh->num_vertices" },
	{ "maya_cube_6100_binary", -1, 0, 802, 0, 0, "binormals" },
	{ "maya_cube_6100_binary", -1, 0, 803, 0, 0, "tangents" },
	{ "blender_282_suzanne_7400_binary", -1, 0, 0, 161, 0, "mesh->uv_sets.data" },
	{ "maya_color_sets_6100_binary", -1, 0, 0, 126, 0, "mesh->color_sets.data" },
	{ "blender_279_default_6100_ascii", 20743, 125, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_no..." },
	{ "maya_cube_6100_binary", 8133, 159, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.dat..." },
	{ "maya_cube_6100_binary", 9008, 159, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.dat..." },
	{ "blender_282_suzanne_7400_binary", 22882, 167, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_uv...." },
	{ "maya_color_sets_6100_binary", 9881, 189, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_col..." },
	{ "maya_cone_6100_binary", 15988, 46, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_cr..." },
	{ "maya_cone_6100_binary", 15491, 146, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
	{ "maya_cone_6100_binary", 15571, 255, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->edge_crease, n, u..." },
	{ "maya_cube_6100_binary", 10494, 241, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
	{ "maya_cube_6100_binary", 10572, 255, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->edge_smoothing, n..." },
	{ "blender_279_ball_6100_ascii", 18380, 125, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->face_smoothing, n..." },
	{ "blender_279_default_6100_ascii", 21651, 125, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
	{ "blender_279_ball_6100_ascii", 18706, 125, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->face_material, n,..." },
	{ "blender_279_default_6100_ascii", 21723, 125, 0, 0, 0, "arr && arr->size >= 1" },
	{ "blender_279_default_6100_ascii", -1, 0, 4965, 0, 0, "material" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 435, 0, "ufbxi_merge_properties(uc, &material->props, material->..." },
	{ "blender_279_default_6100_ascii", -1, 0, 1726, 0, 0, "mesh" },
	{ "blender_279_default_6100_ascii", 20377, 125, 0, 0, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
	...
	{ "blender_279_sausage_6100_ascii", 123884, 59, 0, 0, 0, "indices->size == weights->size" },
	{ "blender_279_sausage_6100_ascii", 126905, 59, 0, 0, 0, "transform->size >= 16" },
	{ "blender_279_sausage_6100_ascii", 127212, 125, 0, 0, 0, "transform_link->size >= 16" },
	{ "blender_279_sausage_6100_ascii", -1, 0, 5191, 0, 0, "deformer" },
	{ "maya_cube_7100_binary", -1, 0, 1120, 0, 0, "layer" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 1175, 0, 0, "curve" },
	{ "maya_game_sausage_7500_binary_combined", -1, 0, 3589, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_CURVE,..." },
	{ "maya_interpolation_modes_7500_binary", 24256, 248, 0, 0, 0, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
	{ "maya_interpolation_modes_7500_binary", 24387, 255, 0, 0, 0, "values = ufbxi_find_array(node, ufbxi_KeyValueFloat, 'r..." },
	{ "maya_interpolation_modes_7500_binary", 24527, 148, 0, 0, 0, "attr_flags = ufbxi_find_array(node, ufbxi_KeyAttrFlags,..." },
	...
	{ "maya_interpolation_modes_7500_binary", 24418, 89, 0, 0, 0, "times->size == values->size" },
	{ "maya_interpolation_modes_7500_binary", 24663, 89, 0, 0, 0, "attr_flags->size == refs->size" },
	{ "maya_interpolation_modes_7500_binary", 24765, 89, 0, 0, 0, "attrs->size == refs->size * 4u" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 0, 258, 0, "keys" },
	{ "maya_interpolation_modes_7500_binary", 25010, 102, 0, 0, 0, "refs_left >= 0" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 1213, 0, 0, "prop" },
	{ "blender_279_sausage_7400_binary", -1, 0, 3272, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_PROP, ..." },
	{ "maya_cube_7100_binary", -1, 0, 0, 242, 0, "ufbxi_push_string_place_str(uc, type)" },
	...
	{ "blender_279_default_7400_binary", 18278, 2, 0, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
	{ "blender_279_default_6100_ascii", 1096, 58, 0, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
	{ "blender_279_default_6100_ascii", 20377, 125, 0, 0, 0, "ufbxi_read_model(uc, node, &object)" },
	{ "blender_279_default_7400_binary", 20939, 226, 0, 0, 0, "ufbxi_read_geometry(uc, node, &object)" },
	...
	{ "maya_cube_7100_binary", -1, 0, 1120, 0, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
	{ "maya_interpolation_modes_7500_binary", 24256, 248, 0, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 1213, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
	{ "blender_279_sausage_6100_ascii", 123884, 59, 0, 0, 0, "ufbxi_read_deformer(uc, node, &object)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5680, 0, 0, "curve" },
	{ "maya_game_sausage_6100_binary_combined", -1, 0, 4120, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_CURVE,..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5681, 0, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
	{ "blender_279_default_6100_ascii", 74774, 59, 0, 0, 0, "ufbxi_find_val1(node, ufbxi_KeyCount, \"Z\", &num_keys)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 480, 0, "curve->keyframes.data" },
	{ "blender_279_default_6100_ascii", 74764, 58, 0, 0, 0, "data_end - data >= 2" },
	{ "blender_279_default_6100_ascii", 74824, 57, 0, 0, 0, "data_end - data >= 3" },
	{ "blender_279_default_6100_ascii", 74843, 85, 0, 0, 0, "data_end - data >= 1" },
	{ "maya_interpolation_modes_6100_binary", 16936, 72, 0, 0, 0, "data_end - data >= 2" },
	...
	{ "maya_interpolation_modes_6100_binary", 16936, 50, 0, 0, 0, "data_end - data >= 2" },
	{ "maya_interpolation_modes_6100_binary", 16969, 97, 0, 0, 0, "Unknown weight mode" },
	{ "blender_279_default_6100_ascii", 74843, 67, 0, 0, 0, "data_end - data >= 1" },
	{ "blender_279_default_6100_ascii", 74815, 44, 0, 0, 0, "Unknown key mode" },
	{ "blender_279_default_6100_ascii", 74790, 122, 0, 0, 0, "data_end - data >= 2" },
	{ "blender_279_default_6100_ascii", 74790, 46, 0, 0, 0, "data == data_end" },
	{ "blender_279_default_6100_ascii", 74692, 59, 0, 0, 0, "ufbxi_get_val1(child, \"C\", (char**)&old_name)" },
	{ "blender_279_default_6100_ascii", 74764, 58, 0, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5760, 0, 0, "prop" },
	{ "blender_279_sausage_6100_ascii", -1, 0, 7653, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_PROP, ..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5744, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5745, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
	{ "blender_279_default_6100_ascii", 74764, 58, 0, 0, 0, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
	{ "blender_279_default_6100_ascii", 74618, 125, 0, 0, 0, "ufbxi_get_val1(node, \"c\", (char**)&type_and_name)" },
	{ "blender_279_default_6100_ascii", 74692, 59, 0, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5667, 0, 0, "layer" },
	{ "blender_279_default_6100_ascii", 74417, 255, 0, 0, 0, "ufbxi_get_val1(node, \"S\", &layer->name)" },
	{ "blender_279_default_6100_ascii", 74618, 125, 0, 0, 0, "ufbxi_read_take_object(uc, child, layer_id)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5045, 0, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
	...
	{ "blender_279_default_6100_ascii", 0, 125, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
	{ "blender_279_default_7400_binary", 3210, 249, 0, 0, 0, "ufbxi_read_document(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 65, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
	{ "blender_279_default_6100_ascii", 26, 125, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
	{ "blender_279_default_6100_ascii", 645, 255, 0, 0, 0, "ufbxi_read_definitions(uc)" },
	{ "blender_279_default_6100_ascii", 469, 125, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
	{ "blender_279_default_6100_ascii", 997, 255, 0, 0, 0, "ufbxi_read_objects(uc)" },
	{ "blender_279_default_6100_ascii", 897, 125, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
	{ "blender_279_default_6100_ascii", 74083, 255, 0, 0, 0, "ufbxi_read_connections(uc)" },
	{ "blender_279_default_6100_ascii", 73304, 125, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 440, 0, "ufbxi_merge_properties(uc, &node->props, node->props.de..." },
	{ "maya_anim_light_7500_binary", -1, 0, 1234, 0, 0, "ufbxi_merge_properties(uc, props, attr->defaults, props..." },
	{ "blender_279_default_7400_binary", -1, 0, 1746, 0, 0, "ufbxi_merge_properties(uc, props, props->defaults, prop..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 518, 0, "ufbxi_merge_properties(uc, props, props, attr, &uc->res..." },
	{ "blender_279_default_7400_binary", 25553, 68, 0, 0, 0, "depth < uc->opts.max_child_depth" },
	{ "blender_279_default_7400_binary", 25553, 68, 0, 0, 0, "ufbxi_check_node_depth(uc, *p_child, depth + 1)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 506, 0, "ufbxi_retain_array(uc, sizeof(ufbx_model), &uc->scene.m..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 507, 0, "ufbxi_retain_array(uc, sizeof(ufbx_mesh), &uc->scene.me..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 508, 0, "ufbxi_retain_array(uc, sizeof(ufbx_material), &uc->scen..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 509, 0, "ufbxi_retain_array(uc, sizeof(ufbx_light), &uc->scene.l..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 9622, 0, "ufbxi_retain_array(uc, sizeof(ufbx_bone), &uc->scene.bo..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 510, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_layer), &uc->sc..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 511, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_prop), &uc->sce..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 512, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_curve), &uc->sc..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 9984, 0, 0, "uc->skin_clusters" },
	{ "blender_279_default_6100_ascii", -1, 0, 5831, 0, 0, "conns" },
	{ "blender_279_default_7400_binary", -1, 0, 1745, 0, 0, "uc->geometries" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 514, 0, "zero_indices && consecutive_indices" },
	{ "blender_279_default_7400_binary", -1, 0, 1748, 0, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 518, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 9990, 0, 0, "parent.skin_deformer->skin_index" },
	...
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 9650, 0, "ufbxi_collect_nodes(uc, sizeof(ufbx_bone), &nodes, uc->..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 9655, 0, "skins" },
	{ "blender_279_sausage_6100_ascii", 11935, 122, 0, 0, 0, "mesh->num_vertices > 0" },
	...
	{ "blender_279_default_6100_ascii", 0, 46, 0, 0, 0, "ufbxi_begin_parse(uc)" },
	{ "blender_279_default_6100_ascii", 0, 255, 0, 0, 0, "ufbxi_read_root(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5831, 0, 0, "ufbxi_finalize_scene(uc)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 1, 0, 0, "ufbxi_map_grow(&uc->string_map, ufbx_string, 16)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 32, 0, "dst" },
	{ "blender_279_default_7400_binary", 331, 0, 0, 0, 0, "str || length == 0" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 16, 0, "str" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 1, "uc->read_fn" },
	{ "blender_279_default_7400_binary", 36, 255, 0, 0, 0, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21281, "uc->read_fn" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 65, "header" },
	{ "blender_279_default_7400_binary", 24, 255, 0, 0, 0, "num_values64 <= (uint64_t)uc->opts.max_node_values" },
	{ "blender_279_default_7400_binary", -1, 0, 96, 0, 0, "node" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 145, "name" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 16, 0, "name" },
	{ "blender_279_default_7400_binary", -1, 0, 1008, 0, 0, "arr" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21217, "data" },
	{ "blender_279_default_7400_binary", 21085, 255, 0, 0, 0, "size <= uc->opts.max_array_size" },
	...
	{ "blender_279_default_7400_binary", 21086, 0, 0, 0, 0, "encoded_size == decoded_data_size" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21281, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
	...
	{ "blender_279_default_6100_ascii", 251, 0, 0, 0, 0, "depth == 0" },
	{ "blender_279_default_6100_ascii", 0, 255, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4763, 0, 0, "name" },
	{ "blender_279_default_6100_ascii", -1, 0, 16, 0, 0, "node" },
	{ "blender_279_default_6100_ascii", -1, 0, 1252, 0, 0, "arr" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 16, 0, "ufbxi_push_string_place_str(uc, &v->s)" },
	{ "maya_cube_6100_ascii", -1, 0, 0, 372, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 160, 0, "v" },
	{ "maya_interpolation_modes_7500_ascii", -1, 0, 849, 0, 0, "v" },
	{ "maya_auto_clamp_7100_ascii", -1, 0, 818, 0, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 4736, 0, 0, "v" },
	{ "maya_auto_clamp_7100_ascii", -1, 0, 816, 0, 0, "v" },
	{ "blender_279_default_6100_ascii", -1, 0, 4720, 0, 0, "v" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 4722, 0, 0, "arr_data" },
	{ "blender_279_default_6100_ascii", -1, 0, 112, 0, 0, "node->vals" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 4676, 0, 0, "node->children" },
	{ "blender_279_default_6100_ascii", 180, 255, 0, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
	{ "blender_279_default_6100_ascii", -1, 0, 1, 0, 0, "ufbxi_push_string_imp(uc, str->data, str->length, false..." },
	{ "blender_279_default_6100_ascii", -1, 0, 9, 0, 0, "ufbxi_map_grow(&uc->prop_type_map, ufbxi_prop_type_name..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 1, 0, "defs" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 257, 0, 0, "prop" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 215, 0, "edges" },
	{ "blender_279_default_7400_binary", 21349, 255, 0, 0, 0, "index_ix >= 0 && (size_t)index_ix < mesh->num_indices" },
	...
	{ "blender_282_suzanne_7400_binary", -1, 0, 0, 98, 0, "mesh->uv_sets.data" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 0, 302, 0, "ufbxi_merge_properties(uc, &material->props, material->..." },
	...
	{ "maya_cube_7100_binary", -1, 0, 809, 0, 0, "layer" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 859, 0, 0, "curve" },
	{ "maya_game_sausage_7500_binary_combined", -1, 0, 3155, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_CURVE,..." },
	...
	{ "maya_interpolation_modes_7500_binary", -1, 0, 0, 151, 0, "keys" },
	{ "maya_interpolation_modes_7500_binary", 25023, 0, 0, 0, 0, "refs_left >= 0" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 912, 0, 0, "prop" },
	{ "blender_279_sausage_7400_binary", -1, 0, 2812, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_PROP, ..." },
	{ "maya_cube_7100_binary", -1, 0, 0, 141, 0, "ufbxi_push_string_place_str(uc, type)" },
	...
	{ "maya_cube_7100_binary", -1, 0, 809, 0, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
	{ "maya_interpolation_modes_7500_binary", 24310, 255, 0, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
	{ "maya_interpolation_modes_7500_binary", -1, 0, 912, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
	{ "blender_279_sausage_6100_ascii", -1, 0, 4824, 0, 0, "ufbxi_read_deformer(uc, node, &object)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5248, 0, 0, "curve" },
	{ "maya_game_sausage_6100_binary_combined", -1, 0, 3048, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_CURVE,..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5296, 0, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5234, 0, 0, "prop" },
	{ "blender_279_sausage_6100_ascii", -1, 0, 6970, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_PROP, ..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5236, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5237, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5232, 0, 0, "layer" },
	{ "blender_279_default_6100_ascii", 74417, 255, 0, 0, 0, "ufbxi_get_val1(node, \"S\", &layer->name)" },
	...
	{ "blender_279_default_6100_ascii", 74083, 255, 0, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
	{ "blender_279_default_6100_ascii", 74100, 80, 0, 0, 0, "ufbxi_get_val_at(node, 3, 'C', (char**)&prop)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4689, 0, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
	{ "blender_279_default_6100_ascii", -1, 0, 14, 0, 0, "model" },
	{ "blender_279_default_6100_ascii", 0, 255, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
	{ "blender_279_default_6100_ascii", 180, 255, 0, 0, 0, "ufbxi_read_header_extension(uc)" },
	...
	{ "blender_279_default_6100_ascii", 74380, 255, 0, 0, 0, "ufbxi_read_takes(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 353, 0, "arr->data" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 366, 0, "node->children.data" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 244, 0, "ufbxi_merge_properties(uc, &node->props, node->props.de..." },
	{ "maya_anim_light_7500_binary", -1, 0, 904, 0, 0, "ufbxi_merge_properties(uc, props, attr->defaults, props..." },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 0, 353, 0, "ufbxi_retain_array(uc, sizeof(ufbx_model), &uc->scene.m..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 354, 0, "ufbxi_retain_array(uc, sizeof(ufbx_mesh), &uc->scene.me..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 355, 0, "ufbxi_retain_array(uc, sizeof(ufbx_material), &uc->scen..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 356, 0, "ufbxi_retain_array(uc, sizeof(ufbx_light), &uc->scene.l..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 7148, 0, "ufbxi_retain_array(uc, sizeof(ufbx_bone), &uc->scene.bo..." },
	...
	{ "blender_279_sausage_6100_ascii", -1, 0, 9034, 0, 0, "uc->skin_clusters" },
	{ "blender_279_default_6100_ascii", -1, 0, 5317, 0, 0, "conns" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 240, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 362, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 363, 0, "layer->props.data" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 364, 0, "mesh->materials.data" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 365, 0, "nodes" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 366, 0, "ufbxi_collect_nodes(uc, sizeof(ufbx_model), &nodes, uc-..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 7162, 0, "ufbxi_collect_nodes(uc, sizeof(ufbx_bone), &nodes, uc->..." },
	{ "blender_279_sausage_6100_ascii", -1, 0, 0, 7165, 0, "skins" },
	...
	{ "blender_279_default_6100_ascii", 0, 255, 0, 0, 0, "ufbxi_read_root(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5317, 0, 0, "ufbxi_finalize_scene(uc)" },
};
