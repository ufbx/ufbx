...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
	...
	{ "synthetic_color_suzanne_0_obj", 13071, -1, 0, 0, 10, 0, 0, "mesh->vertex_first_index.data" },
	{ "synthetic_color_suzanne_0_obj", 13088, -1, 0, 0, 11, 0, 0, "uv_set" },
	{ "synthetic_color_suzanne_0_obj", 13101, -1, 0, 0, 12, 0, 0, "color_set" },
	{ "synthetic_color_suzanne_0_obj", 13152, -1, 0, 2113, 0, 0, 0, "mesh" },
	{ "synthetic_color_suzanne_0_obj", 13152, -1, 0, 2114, 0, 0, 0, "mesh" },
	{ "synthetic_color_suzanne_0_obj", 13170, -1, 0, 2114, 0, 0, 0, "mesh->fbx_node && mesh->fbx_mesh" },
	{ "synthetic_color_suzanne_0_obj", 13170, -1, 0, 2115, 0, 0, 0, "mesh->fbx_node && mesh->fbx_mesh" },
	{ "synthetic_color_suzanne_0_obj", 13180, -1, 0, 2118, 0, 0, 0, "ufbxi_connect_oo(uc, mesh->fbx_mesh_id, mesh->fbx_node_..." },
	{ "synthetic_color_suzanne_0_obj", 13180, -1, 0, 2119, 0, 0, 0, "ufbxi_connect_oo(uc, mesh->fbx_mesh_id, mesh->fbx_node_..." },
	{ "synthetic_color_suzanne_0_obj", 13181, -1, 0, 2119, 0, 0, 0, "ufbxi_connect_oo(uc, mesh->fbx_node_id, 0)" },
	{ "synthetic_color_suzanne_0_obj", 13181, -1, 0, 2120, 0, 0, 0, "ufbxi_connect_oo(uc, mesh->fbx_node_id, 0)" },
	{ "synthetic_color_suzanne_0_obj", 13291, -1, 0, 0, 0, 0, 1, "ufbxi_report_progress(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13357, -1, 0, 8, 0, 0, 0, "ufbxi_grow_array_size((&uc->ator_tmp), sizeof(**(&uc->o..." },
	{ "synthetic_color_suzanne_0_obj", 13357, -1, 0, 9, 0, 0, 0, "ufbxi_grow_array_size((&uc->ator_tmp), sizeof(**(&uc->o..." },
	{ "synthetic_color_suzanne_0_obj", 13393, -1, 0, 0, 0, 0, 1, "ufbxi_obj_read_line(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13394, -1, 0, 8, 0, 0, 0, "ufbxi_obj_tokenize(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13394, -1, 0, 9, 0, 0, 0, "ufbxi_obj_tokenize(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13412, 29701, 0, 0, 0, 0, 0, "offset + read_values <= uc->obj.num_tokens" },
	{ "synthetic_color_suzanne_0_obj", 13415, -1, 0, 12, 0, 0, 0, "vals" },
	{ "synthetic_color_suzanne_0_obj", 13415, -1, 0, 13, 0, 0, 0, "vals" },
	{ "synthetic_color_suzanne_0_obj", 13421, 52, 47, 0, 0, 0, 0, "end == str.data + str.length" },
	{ "synthetic_color_suzanne_0_obj", 13470, -1, 0, 2123, 0, 0, 0, "dst" },
	{ "synthetic_color_suzanne_0_obj", 13470, -1, 0, 2124, 0, 0, 0, "dst" },
	{ "synthetic_color_suzanne_0_obj", 13511, -1, 0, 2113, 0, 0, 0, "ufbxi_obj_push_mesh(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13511, -1, 0, 2114, 0, 0, 0, "ufbxi_obj_push_mesh(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13576, -1, 0, 2120, 0, 0, 0, "face" },
	{ "synthetic_color_suzanne_0_obj", 13576, -1, 0, 2121, 0, 0, 0, "face" },
	{ "synthetic_color_suzanne_0_obj", 13585, -1, 0, 2121, 0, 0, 0, "p_face_mat" },
	{ "synthetic_color_suzanne_0_obj", 13585, -1, 0, 2122, 0, 0, 0, "p_face_mat" },
	{ "synthetic_color_suzanne_0_obj", 13590, -1, 0, 2122, 0, 0, 0, "p_face_smooth" },
	{ "synthetic_color_suzanne_0_obj", 13590, -1, 0, 2123, 0, 0, 0, "p_face_smooth" },
	{ "synthetic_color_suzanne_0_obj", 13603, -1, 0, 2123, 0, 0, 0, "ufbxi_obj_parse_index(uc, &tok, attrib)" },
	{ "synthetic_color_suzanne_0_obj", 13603, -1, 0, 2124, 0, 0, 0, "ufbxi_obj_parse_index(uc, &tok, attrib)" },
	{ "synthetic_color_suzanne_0_obj", 13744, -1, 0, 0, 1, 0, 0, "data" },
	{ "synthetic_color_suzanne_0_obj", 13782, -1, 0, 0, 7, 0, 0, "dst_indices" },
	{ "synthetic_color_suzanne_0_obj", 13884, -1, 0, 0, 1, 0, 0, "ufbxi_obj_pop_vertices(uc, &vertices[attrib], attrib, m..." },
	{ "synthetic_color_suzanne_0_obj", 13889, -1, 0, 0, 0, 55277, 0, "min_ix < 0xffffffffffffffffui64" },
	{ "synthetic_color_suzanne_0_obj", 13890, -1, 0, 0, 3, 0, 0, "ufbxi_obj_pop_vertices(uc, &vertices[UFBXI_OBJ_ATTRIB_C..." },
	{ "synthetic_color_suzanne_0_obj", 13901, -1, 0, 0, 4, 0, 0, "fbx_mesh->faces.data" },
	{ "synthetic_color_suzanne_0_obj", 13902, -1, 0, 0, 5, 0, 0, "fbx_mesh->face_material.data" },
	{ "synthetic_color_suzanne_0_obj", 13907, -1, 0, 0, 6, 0, 0, "fbx_mesh->face_smoothing.data" },
	{ "synthetic_color_suzanne_0_obj", 13917, -1, 0, 0, 7, 0, 0, "ufbxi_obj_setup_attrib(uc, mesh, tmp_indices, (ufbx_ver..." },
	{ "synthetic_color_suzanne_0_obj", 13920, -1, 0, 0, 8, 0, 0, "ufbxi_obj_setup_attrib(uc, mesh, tmp_indices, (ufbx_ver..." },
	{ "synthetic_color_suzanne_0_obj", 13923, -1, 0, 0, 9, 0, 0, "ufbxi_obj_setup_attrib(uc, mesh, tmp_indices, (ufbx_ver..." },
	{ "synthetic_color_suzanne_0_obj", 13965, -1, 0, 0, 10, 0, 0, "ufbxi_finalize_mesh(&uc->result, &uc->error, fbx_mesh)" },
	{ "synthetic_color_suzanne_0_obj", 13985, -1, 0, 3, 0, 0, 0, "root" },
	{ "synthetic_color_suzanne_0_obj", 13985, -1, 0, 4, 0, 0, 0, "root" },
	{ "synthetic_color_suzanne_0_obj", 13987, -1, 0, 7, 0, 0, 0, "((uint32_t*)ufbxi_push_size_copy((&uc->tmp_node_ids), s..." },
	{ "synthetic_color_suzanne_0_obj", 13987, -1, 0, 8, 0, 0, 0, "((uint32_t*)ufbxi_push_size_copy((&uc->tmp_node_ids), s..." },
	{ "synthetic_color_suzanne_0_obj", 13991, -1, 0, 8, 0, 0, 0, "ufbxi_obj_tokenize_line(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13991, -1, 0, 9, 0, 0, 0, "ufbxi_obj_tokenize_line(uc)" },
	{ "synthetic_color_suzanne_0_obj", 13998, 52, 47, 0, 0, 0, 0, "ufbxi_obj_parse_vertex(uc, UFBXI_OBJ_ATTRIB_POSITION, 1..." },
	{ "synthetic_color_suzanne_0_obj", 14005, 80, 47, 0, 0, 0, 0, "ufbxi_obj_parse_vertex(uc, UFBXI_OBJ_ATTRIB_COLOR, 4)" },
	{ "synthetic_color_suzanne_0_obj", 14007, -1, 0, 14, 0, 0, 0, "valid" },
	{ "synthetic_color_suzanne_0_obj", 14007, -1, 0, 15, 0, 0, 0, "valid" },
	{ "synthetic_color_suzanne_0_obj", 14012, 29703, 47, 0, 0, 0, 0, "ufbxi_obj_parse_vertex(uc, UFBXI_OBJ_ATTRIB_UV, 1)" },
	{ "synthetic_color_suzanne_0_obj", 14014, 41935, 47, 0, 0, 0, 0, "ufbxi_obj_parse_vertex(uc, UFBXI_OBJ_ATTRIB_NORMAL, 1)" },
	{ "synthetic_color_suzanne_0_obj", 14016, -1, 0, 2113, 0, 0, 0, "ufbxi_obj_parse_indices(uc)" },
	{ "synthetic_color_suzanne_0_obj", 14016, -1, 0, 2114, 0, 0, 0, "ufbxi_obj_parse_indices(uc)" },
	{ "synthetic_color_suzanne_0_obj", 14054, -1, 0, 0, 1, 0, 0, "ufbxi_obj_pop_meshes(uc)" },
	{ "synthetic_color_suzanne_0_obj", 14275, 52, 47, 0, 0, 0, 0, "ufbxi_obj_parse_file(uc)" },
	{ "synthetic_color_suzanne_0_obj", 14276, -1, 0, 0, 13, 0, 0, "ufbxi_init_file_paths(uc)" },
	{ "synthetic_color_suzanne_0_obj", 19835, 52, 47, 0, 0, 0, 0, "ufbxi_obj_load(uc)" },
	{ "synthetic_color_suzanne_0_obj", 9884, -1, 0, 2114, 0, 0, 0, "((size_t*)ufbxi_push_size_copy((&uc->tmp_typed_element_..." },
	{ "synthetic_color_suzanne_0_obj", 9884, -1, 0, 2115, 0, 0, 0, "((size_t*)ufbxi_push_size_copy((&uc->tmp_typed_element_..." },
	{ "synthetic_color_suzanne_0_obj", 9885, -1, 0, 2116, 0, 0, 0, "((size_t*)ufbxi_push_size_copy((&uc->tmp_element_offset..." },
	{ "synthetic_color_suzanne_0_obj", 9885, -1, 0, 2117, 0, 0, 0, "((size_t*)ufbxi_push_size_copy((&uc->tmp_element_offset..." },
	{ "synthetic_color_suzanne_0_obj", 9889, -1, 0, 2114, 0, 0, 0, "elem" },
	{ "synthetic_color_suzanne_0_obj", 9889, -1, 0, 2115, 0, 0, 0, "elem" },
	{ "synthetic_color_suzanne_0_obj", 9930, -1, 0, 2118, 0, 0, 0, "conn" },
	{ "synthetic_color_suzanne_0_obj", 9930, -1, 0, 2119, 0, 0, 0, "conn" },
	{ "synthetic_color_suzanne_1_obj", 13021, -1, 0, 0, 16, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &dst, raw..." },
	{ "synthetic_color_suzanne_1_obj", 13124, -1, 0, 0, 3, 0, 0, "props.data" },
	{ "synthetic_color_suzanne_1_obj", 13191, -1, 0, 0, 3, 0, 0, "ufbxi_obj_pop_props(uc, &uc->obj.mesh->fbx_mesh->props...." },
	{ "synthetic_color_suzanne_1_obj", 13518, -1, 0, 1628, 0, 0, 0, "ufbxi_connect_oo(uc, uc->obj.usemtl_fbx_id, mesh->fbx_n..." },
	{ "synthetic_color_suzanne_1_obj", 13518, -1, 0, 1629, 0, 0, 0, "ufbxi_connect_oo(uc, uc->obj.usemtl_fbx_id, mesh->fbx_n..." },
	{ "synthetic_color_suzanne_1_obj", 13531, -1, 0, 1629, 0, 0, 0, "entry" },
	{ "synthetic_color_suzanne_1_obj", 13531, -1, 0, 1630, 0, 0, 0, "entry" },
	{ "synthetic_color_suzanne_1_obj", 13544, -1, 0, 1630, 0, 0, 0, "prop" },
	{ "synthetic_color_suzanne_1_obj", 13544, -1, 0, 1631, 0, 0, 0, "prop" },
	{ "synthetic_color_suzanne_1_obj", 13552, -1, 0, 0, 2, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &prop->na..." },
	{ "synthetic_color_suzanne_1_obj", 13596, -1, 0, 1633, 0, 0, 0, "p_face_group" },
	{ "synthetic_color_suzanne_1_obj", 13596, -1, 0, 1634, 0, 0, 0, "p_face_group" },
	{ "synthetic_color_suzanne_1_obj", 13647, -1, 0, 526, 0, 0, 0, "p_rgba && p_valid" },
	{ "synthetic_color_suzanne_1_obj", 13647, -1, 0, 527, 0, 0, 0, "p_rgba && p_valid" },
	{ "synthetic_color_suzanne_1_obj", 13673, -1, 0, 0, 0, 257, 0, "uc->obj.num_tokens >= 2" },
	{ "synthetic_color_suzanne_1_obj", 13692, -1, 0, 13, 0, 0, 0, "material" },
	{ "synthetic_color_suzanne_1_obj", 13692, -1, 0, 14, 0, 0, 0, "material" },
	{ "synthetic_color_suzanne_1_obj", 13699, -1, 0, 15, 0, 0, 0, "ufbxi_grow_array_size((&uc->ator_tmp), sizeof(**(&uc->o..." },
	{ "synthetic_color_suzanne_1_obj", 13699, -1, 0, 16, 0, 0, 0, "ufbxi_grow_array_size((&uc->ator_tmp), sizeof(**(&uc->o..." },
	{ "synthetic_color_suzanne_1_obj", 13740, 32088, 33, 0, 0, 0, 0, "min_index < uc->obj.tmp_vertices[attrib].num_items / st..." },
	{ "synthetic_color_suzanne_1_obj", 13913, -1, 0, 0, 9, 0, 0, "fbx_mesh->face_group.data" },
	{ "synthetic_color_suzanne_1_obj", 14036, -1, 0, 0, 1, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &uc->obj...." },
	{ "synthetic_color_suzanne_1_obj", 14040, -1, 0, 526, 0, 0, 0, "ufbxi_obj_parse_comment(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14040, -1, 0, 527, 0, 0, 0, "ufbxi_obj_parse_comment(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14042, -1, 0, 0, 0, 215, 0, "uc->obj.num_tokens >= 2" },
	{ "synthetic_color_suzanne_1_obj", 14045, -1, 0, 12, 0, 0, 0, "lib.data" },
	{ "synthetic_color_suzanne_1_obj", 14045, -1, 0, 13, 0, 0, 0, "lib.data" },
	{ "synthetic_color_suzanne_1_obj", 14049, -1, 0, 13, 0, 0, 0, "ufbxi_obj_parse_material(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14049, -1, 0, 14, 0, 0, 0, "ufbxi_obj_parse_material(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14053, -1, 0, 0, 3, 0, 0, "ufbxi_obj_flush_mesh(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14068, -1, 0, 0, 25, 0, 0, "ufbxi_obj_pop_props(uc, &material->props.props, num_pro..." },
	{ "synthetic_color_suzanne_1_obj", 14086, -1, 0, 0, 17, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &prop->na..." },
	{ "synthetic_color_suzanne_1_obj", 14113, -1, 0, 0, 18, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &prop->va..." },
	{ "synthetic_color_suzanne_1_obj", 14142, -1, 0, 0, 21, 0, 0, "ufbxi_obj_parse_prop(uc, ufbxi_str_c(\"obj|args\"), 1, ..." },
	{ "synthetic_color_suzanne_1_obj", 14173, -1, 0, 0, 23, 0, 0, "ufbxi_obj_pop_props(uc, &texture->props.props, num_prop..." },
	{ "synthetic_color_suzanne_1_obj", 14179, -1, 0, 0, 24, 0, 0, "ufbxi_push_string_place_str(&uc->string_pool, &prop, 0)" },
	{ "synthetic_color_suzanne_1_obj", 14194, -1, 0, 0, 0, 0, 1586, "ufbxi_obj_tokenize_line(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14204, -1, 0, 0, 21, 0, 0, "ufbxi_obj_parse_mtl_map(uc, 4)" },
	{ "synthetic_color_suzanne_1_obj", 14208, -1, 0, 0, 17, 0, 0, "ufbxi_obj_parse_prop(uc, uc->obj.tokens[0], 1, 1, ((voi..." },
	{ "synthetic_color_suzanne_1_obj", 14212, -1, 0, 0, 25, 0, 0, "ufbxi_obj_flush_material(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14251, -1, 0, 0, 16, 0, 0, "ufbxi_resolve_relative_filename(uc, (ufbxi_strblob*)&ds..." },
	{ "synthetic_color_suzanne_1_obj", 14266, -1, 0, 0, 17, 0, 0, "ok" },
	{ "synthetic_color_suzanne_1_obj", 14277, -1, 0, 0, 16, 0, 0, "ufbxi_obj_load_mtl(uc)" },
	{ "synthetic_color_suzanne_1_obj", 14836, -1, 0, 0, 40, 0, 0, "list->data" },
	{ "synthetic_color_suzanne_1_obj", 16488, -1, 0, 0, 41, 0, 0, "texture->file_textures.data" },
	{ "synthetic_color_suzanne_1_obj", 17335, -1, 0, 0, 40, 0, 0, "ufbxi_fetch_textures(uc, &material->textures, &material..." },
	{ "synthetic_color_suzanne_1_obj", 17620, -1, 0, 0, 41, 0, 0, "ufbxi_fetch_file_textures(uc)" },
};
