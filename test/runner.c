...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "maya_pivots", 6101, -1, 0, 49, 0, "ator->allocs_left > 1" },
        { "maya_pivots", 6101, -1, 0, 53, 0, "ator->allocs_left > 1" },
        { "maya_pivots", 6101, -1, 0, 49, 0, "data" },
        { "maya_pivots", 6101, -1, 0, 19, 0, "ufbxi_map_grow(&uc->string_map, ufbx_string, 16)" },
        { "maya_pivots", 6101, -1, 0, 0, 64, "dst" },
        { "maya_pivots", 6101, -1, 0, 5, 0, "str" },
        { "maya_pivots", 6101, -1, 0, 266, 0, "data" },
        { "maya_pivots", 6101, -1, 0, 16, 0, "node" },
        { "maya_pivots", 6101, -1, 0, 19, 0, "name" },
        { "maya_pivots", 6101, -1, 0, 321, 0, "arr" },
        { "maya_pivots", 7501, -1, 0, 582, 0, "arr_data" },
        { "maya_pivots", 6101, -1, 0, 266, 0, "arr_data" },
        { "maya_pivots", 6101, -1, 0, 48, 0, "vals" },
        { "maya_pivots", 6101, -1, 0, 0, 208, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
        { "maya_pivots", 6101, -1, 0, 32, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
        { "maya_pivots", 6101, -1, 0, 84, 0, "node->children" },
        { "maya_pivots", 6102, -1, 0, 6, 0, "ufbxi_grow_array(&uc->ator_tmp, &token->str_data, &toke..." },
        { "maya_pivots", 6102, -1, 0, 6, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "maya_pivots", 6102, -1, 0, 12, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "maya_pivots", 6102, -1, 0, 12, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "maya_pivots", 6102, -1, 0, 12, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 6102, -1, 0, 19, 0, "name" },
        { "maya_pivots", 6102, -1, 0, 16, 0, "node" },
        { "maya_pivots", 6102, -1, 0, 325, 0, "arr" },
        { "maya_pivots", 6102, -1, 0, 0, 132, "ufbxi_push_string_place_str(uc, &v->s)" },
        { "maya_pivots", 6102, -1, 0, 260, 0, "v" },
        { "maya_pivots", 6102, -1, 0, 0, 208, "v" },
        { "maya_pivots", 6102, -1, 0, 0, 160, "v" },
        { "maya_pivots", 6102, -1, 0, 272, 0, "arr_data" },
        { "maya_pivots", 6102, -1, 0, 64, 0, "node->vals" },
        { "maya_pivots", 6102, -1, 0, 80, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        { "maya_pivots", 6102, -1, 0, 82, 0, "node->children" },
        { "maya_pivots", 6102, -1, 0, 6, 0, "ufbxi_ascii_next_token(uc, &uc->ascii.token)" },
        { "maya_pivots", 6102, -1, 0, 16, 0, "ufbxi_ascii_parse_node(uc, 0, state, p_end, buf, true)" },
        { "maya_pivots", 6101, -1, 0, 16, 0, "ufbxi_binary_parse_node(uc, 0, state, p_end, buf, true)" },
        { "maya_pivots", 6102, -1, 0, 50, 0, "ufbxi_ascii_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, &..." },
        { "maya_pivots", 6101, -1, 0, 64, 0, "ufbxi_binary_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, ..." },
        { "maya_pivots", 6101, -1, 0, 53, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
        { "maya_pivots", 6101, -1, 0, 61, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        { "maya_pivots", 6101, -1, 0, 63, 0, "node->children" },
        { "maya_pivots", 6101, -1, 0, 16, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
        { "maya_pivots", 6101, -1, 0, 1, 0, "ufbxi_push_string_imp(uc, str->data, str->length, false..." },
        { "maya_pivots", 6101, -1, 0, 4, 0, "ufbxi_map_grow(&uc->prop_type_map, ufbxi_prop_type_name..." },
        { "maya_pivots", 6101, -1, 0, 0, 1, "defs" },
        { "maya_pivots", 6101, -1, 0, 0, 3, "defs->props" },
        { "maya_pivots", 6101, -1, 0, 5, 0, "ufbxi_push_string_place_str(uc, &prop->name)" },
        { "maya_pivots", 6101, -1, 0, 0, 97, "ufbxi_push_string_place_str(uc, &prop->value_str)" },
        { "maya_pivots", 6101, -1, 0, 481, 0, "conn" },
        { "maya_pivots", 6101, -1, 0, 49, 0, "ufbxi_map_grow(&uc->connectable_map, ufbxi_connectable,..." },
        { "maya_pivots", 6101, -1, 0, 16, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "maya_pivots", 7501, -1, 0, 160, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "maya_pivots", 7501, -1, 0, 162, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        { "maya_pivots", 6101, -1, 0, 474, 0, "dst->props" },
        { "maya_pivots", 6101, -1, 0, 474, 0, "ufbxi_sort_properties(uc, &left, &uc->tmp_sort)" },
        { "maya_pivots", 6101, -1, 0, 476, 0, "ufbxi_sort_properties(uc, &right, &uc->tmp_sort)" },
        { "maya_pivots", 6101, -1, 0, 474, 0, "ufbxi_merge_properties(uc, dst, &left, &right, buf)" },
        { "maya_pivots", 6101, -1, 0, 0, 214, "dst->props" },
        { "maya_pivots", 6101, -1, 0, 400, 0, "prop" },
        { "maya_pivots", 6101, -1, 0, 472, 0, "props->props" },
        { "maya_pivots", 6101, -1, 0, 474, 0, "ufbxi_sort_properties(uc, props, buf)" },
        { "maya_pivots", 6101, -1, 0, 80, 0, "ufbxi_parse_toplevel_child(uc, &object)" },
        { "maya_pivots", 7501, -1, 0, 194, 0, "tmpl" },
        { "maya_pivots", 7501, -1, 0, 240, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
        { "maya_pivots", 7501, -1, 0, 571, 0, "uc->templates" },
        { "maya_pivots", 6101, -1, 0, 480, 0, "mesh" },
        { "maya_pivots", 6101, -1, 0, 0, 180, "edges" },
        { "maya_pivots", 6101, -1, 0, 0, 181, "mesh->faces" },
        { "maya_pivots", 6101, -1, 0, 0, 182, "mesh->uv_sets.data" },
        { "maya_pivots", 6101, -1, 0, 477, 0, "mesh" },
        { "maya_pivots", 6101, -1, 0, 480, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
        { "maya_pivots", 6101, -1, 0, 481, 0, "ufbxi_add_connection(uc, object->id, geom_obj.id, NULL)" },
        { "maya_pivots", 7501, -1, 0, 818, 0, "layer" },
        { "maya_pivots", 7501, -1, 0, 0, 260, "ufbxi_push_string_place_str(uc, type)" },
        { "maya_pivots", 6101, -1, 0, 0, 178, "ufbxi_push_string_place_str(uc, name)" },
        { "maya_pivots", 6101, -1, 0, 240, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "maya_pivots", 6101, -1, 0, 0, 178, "ufbxi_split_type_and_name(uc, type_and_name, &type_str,..." },
        { "maya_pivots", 7501, -1, 0, 752, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
        { "maya_pivots", 6101, -1, 0, 400, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
        { "maya_pivots", 6101, -1, 0, 480, 0, "ufbxi_read_model(uc, node, &object)" },
        { "maya_pivots", 7501, -1, 0, 713, 0, "ufbxi_read_geometry(uc, node, &object)" },
        { "maya_pivots", 7501, -1, 0, 818, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
        { "maya_pivots", 6101, -1, 0, 688, 0, "layer" },
        { "maya_pivots", 6101, -1, 0, 677, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "maya_pivots", 6101, -1, 0, 688, 0, "ufbxi_read_take(uc, node)" },
        { "maya_pivots", 6101, -1, 0, 673, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "maya_pivots", 6101, -1, 0, 672, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
        { "maya_pivots", 6101, -1, 0, 6, 0, "model" },
        { "maya_pivots", 6101, -1, 0, 8, 0, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
        { "maya_pivots", 6101, -1, 0, 16, 0, "ufbxi_read_header_extension(uc)" },
        { "maya_pivots", 7501, -1, 0, 128, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
        { "maya_pivots", 7501, -1, 0, 160, 0, "ufbxi_read_document(uc)" },
        { "maya_pivots", 6101, -1, 0, 49, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        { "maya_pivots", 6101, -1, 0, 64, 0, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
        { "maya_pivots", 6101, -1, 0, 80, 0, "ufbxi_read_definitions(uc)" },
        { "maya_pivots", 6101, -1, 0, 90, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
        { "maya_pivots", 6101, -1, 0, 240, 0, "ufbxi_read_objects(uc)" },
        { "maya_pivots", 6101, -1, 0, 668, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
        { "maya_pivots", 6101, -1, 0, 672, 0, "ufbxi_read_connections(uc)" },
        { "maya_pivots", 6101, -1, 0, 676, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
        { "maya_pivots", 6101, -1, 0, 688, 0, "ufbxi_read_takes(uc)" },
        { "maya_pivots", 6101, -1, 0, 0, 247, "arr->data" },
        { "maya_pivots", 6101, -1, 0, 0, 253, "node->children.data" },
        { "maya_pivots", 6101, -1, 0, 0, 251, "ufbxi_merge_properties(uc, props, props, attr, &uc->res..." },
        { "maya_pivots", 6101, -1, 0, 0, 247, "ufbxi_retain_array(uc, sizeof(ufbx_model), &uc->scene.m..." },
        { "maya_pivots", 6101, -1, 0, 0, 248, "ufbxi_retain_array(uc, sizeof(ufbx_mesh), &uc->scene.me..." },
        { "maya_pivots", 6101, -1, 0, 0, 249, "ufbxi_retain_array(uc, sizeof(ufbx_anim_layer), &uc->sc..." },
        { "maya_pivots", 6101, -1, 0, 690, 0, "conns" },
        { "maya_pivots", 7501, -1, 0, 835, 0, "uc->geometries" },
        { "maya_pivots", 6101, -1, 0, 0, 250, "zero_indices && consecutive_indices" },
        { "maya_pivots", 6101, -1, 0, 0, 251, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
        { "maya_pivots", 6101, -1, 0, 0, 252, "nodes" },
        { "maya_pivots", 6101, -1, 0, 0, 253, "ufbxi_collect_nodes(uc, sizeof(ufbx_model), &nodes, uc-..." },
        { "maya_pivots", 6101, -1, 0, 1, 0, "ufbxi_load_strings(uc)" },
        { "maya_pivots", 6101, -1, 0, 4, 0, "ufbxi_load_maps(uc)" },
        { "maya_pivots", 6101, -1, 0, 5, 0, "ufbxi_load_default_props(uc)" },
        { "maya_pivots", 6102, -1, 0, 6, 0, "ufbxi_begin_parse(uc)" },
        { "maya_pivots", 6101, -1, 0, 16, 0, "ufbxi_read_root(uc)" },
        { "maya_pivots", 6101, -1, 0, 690, 0, "ufbxi_finalize_scene(uc)" },
};
