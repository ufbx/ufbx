...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "synthetic_missing_version", 6102, 6402, 49, "total <= ator->max_size - ator->current_size" },
        { "blender_279_default", 7401, 205, 255, "str || length == 0" },
        { "blender_279_default", 7401, 80, 115, "uc->read_fn" },
        { "blender_279_default", 7401, 80, 115, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
        { "blender_279_default", 7401, 20255, 112, "Bad multivalue array type" },
        { "maya_auto_clamp", 7101, 15644, 113, "Bad multivalue array type" },
        { "maya_interpolation_modes", 7501, 23056, 81, "Bad multivalue array type" },
        { "blender_279_default", 7401, 20485, 255, "Bad multivalue array type" },
        { "blender_279_default", 7401, 260, 255, "num_values64 <= (uint64_t)uc->opts.max_node_values" },
        { "blender_279_default", 7401, 21214, 255, "size <= uc->opts.max_array_size" },
        { "blender_279_default", 7401, 21003, 81, "encoded_size == decoded_data_size" },
        { "blender_279_default", 7401, 19977, 255, "res == (ptrdiff_t)decoded_data_size" },
        { "blender_279_default", 7401, 21215, 255, "Bad array encoding" },
        { "blender_279_default", 7401, 20255, 112, "ufbxi_binary_parse_multivalue_array(uc, dst_type, arr_d..." },
        { "blender_279_default", 7401, 205, 255, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
        { "blender_279_default", 7401, 80, 115, "ufbxi_skip_bytes(uc, encoded_size)" },
        { "blender_279_default", 7401, 80, 113, "Bad values type" },
        { "blender_279_default", 7401, 261, 4, "offset <= values_end_offset" },
        { "blender_279_default", 7401, 262, 255, "ufbxi_skip_bytes(uc, values_end_offset - offset)" },
        { "blender_279_default", 7401, 208, 230, "current_offset == end_offset" },
        { "blender_279_default", 7401, 80, 115, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
        { "blender_279_default", 6102, 3, 255, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 8, 255, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 479, 255, "c != '\\0'" },
        { "blender_279_default", 6102, 479, 255, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "blender_279_default", 6102, 3, 255, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "blender_279_default", 6102, 1, 60, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 7502, 8456, 110, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
        { "maya_pivots", 7502, 8462, 99, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 7502, 7944, 255, "ufbxi_ascii_accept(uc, '}')" },
        { "blender_279_default", 6102, 224, 55, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        { "blender_279_default", 6102, 3, 71, "ufbxi_ascii_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 7401, 80, 115, "ufbxi_binary_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 6102, 1, 60, "ufbxi_ascii_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, &..." },
        { "blender_279_default", 7401, 1735, 82, "ufbxi_binary_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, ..." },
        { "synthetic_missing_version", 6102, 6402, 49, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
        { "blender_279_default", 6102, 3, 71, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        { "blender_279_default", 6102, 223, 255, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
        { "blender_279_default", 6102, 223, 255, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "blender_279_default", 7401, 3120, 81, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "blender_279_default", 6102, 11274, 0, "ufbxi_get_val2(node, \"SC\", &prop->name, (char**)&type..." },
        { "blender_279_default", 7401, 10763, 0, "ufbxi_get_val_at(node, val_ix++, 'C', (char**)&subtype_..." },
        { "blender_279_default", 6102, 11274, 0, "ufbxi_read_property(uc, prop_node, prop, version)" },
        { "blender_279_default", 6102, 520, 255, "ufbxi_parse_toplevel_child(uc, &object)" },
        { "maya_rotation_order", 7502, 3295, 0, "ufbxi_get_val1(props, \"S\", &tmpl->sub_type)" },
        { "maya_auto_clamp", 7101, 4111, 0, "ufbxi_get_val1(object, \"C\", (char**)&tmpl->type)" },
        { "blender_279_default", 7401, 9997, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
        { "blender_279_default", 6102, 20744, 0, "data" },
        { "maya_pivots", 6101, 9701, 255, "data->size % num_components == 0" },
        { "blender_279_default", 7401, 21259, 0, "ufbxi_find_val1(node, ufbxi_MappingInformationType, \"C..." },
        { "maya_rotation_order", 6101, 6662, 255, "Invalid mapping" },
        { "blender_279_default", 7401, 21251, 251, "Invalid mapping" },
        { "blender_279_default", 6102, 20316, 107, "vertices && indices" },
        { "maya_rotation_order", 6101, 31781, 67, "vertices->size % 3 == 0" },
        { "maya_pivots", 6102, 4624, 65, "index_data[mesh->num_indices - 1] < 0" },
        { "maya_rotation_order", 6101, 6147, 255, "index_ix >= 0 && (size_t)index_ix < mesh->num_indices" },
        { "blender_279_default", 7401, 21249, 255, "ix < mesh->num_vertices" },
        { "blender_279_default", 6102, 20744, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_no..." },
        { "blender_282_suzanne_and_transform", 7401, 22960, 255, "ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_uv...." },
        { "blender_279_default", 6102, 20316, 107, "ufbxi_read_geometry(uc, node, &geom_obj)" },
        { "maya_interpolation_modes", 7502, 11529, 111, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
        { "maya_interpolation_modes", 7501, 23809, 84, "values = ufbxi_find_array(node, ufbxi_KeyValueFloat, 'r..." },
        { "maya_interpolation_modes", 7501, 24067, 83, "attr_flags = ufbxi_find_array(node, ufbxi_KeyAttrFlags,..." },
        { "maya_interpolation_modes", 7501, 22799, 93, "attrs = ufbxi_find_array(node, ufbxi_KeyAttrDataFloat, ..." },
        { "maya_interpolation_modes", 7501, 24580, 117, "refs = ufbxi_find_array(node, ufbxi_KeyAttrRefCount, 'i..." },
        { "maya_auto_clamp", 7702, 13079, 0, "attr_flags->size == refs->size" },
        { "maya_interpolation_modes", 7502, 13837, 255, "refs_left >= 0" },
        { "blender_279_default", 7401, 18205, 0, "ufbxi_check_string(*type)" },
        { "blender_279_default", 7401, 18188, 0, "ufbxi_check_string(*name)" },
        { "blender_279_default", 6102, 928, 44, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 7401, 18188, 0, "ufbxi_split_type_and_name(uc, type_and_name, &type_str,..." },
        { "blender_279_default", 7401, 18180, 255, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
        { "blender_279_default", 6102, 11274, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
        { "blender_279_default", 6102, 20316, 107, "ufbxi_read_model(uc, node, &object)" },
        { "blender_279_default", 7401, 20751, 255, "ufbxi_read_geometry(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, 22799, 93, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "blender_279_default", 6102, 74256, 109, "ufbxi_find_val1(node, ufbxi_KeyCount, \"Z\", &num_keys)" },
        { "blender_279_default", 6102, 75018, 0, "data_end - data >= 3" },
        { "maya_auto_clamp", 6102, 10763, 0, "data_end - data >= 4" },
        { "blender_279_default", 6102, 76811, 75, "Unknown key mode" },
        { "synthetic_missing_version", 6102, 77057, 50, "data_end - data >= 2" },
        { "synthetic_missing_version", 6102, 77057, 48, "data == data_end" },
        { "blender_279_default", 6102, 78851, 0, "ufbxi_get_val1(child, \"C\", (char**)&old_name)" },
        { "blender_279_default", 6102, 75018, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, 74256, 109, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
        { "blender_279_default", 6102, 74256, 109, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, 74256, 109, "ufbxi_read_take_object(uc, child, layer_id)" },
        { "blender_279_default", 6102, 70669, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, 74256, 109, "ufbxi_read_take(uc, node)" },
        { "blender_279_default", 6102, 70409, 255, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, 74244, 80, "ufbxi_get_val_at(node, 3, 'C', (char**)&prop)" },
        { "blender_279_default", 6102, 1, 60, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
        { "blender_279_default", 6102, 223, 255, "ufbxi_read_header_extension(uc)" },
        { "blender_279_default", 6102, 1, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
        { "blender_279_default", 7401, 3120, 81, "ufbxi_read_document(uc)" },
        { "blender_279_default", 6102, 9, 50, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
        { "blender_279_default", 6102, 520, 255, "ufbxi_read_definitions(uc)" },
        { "blender_279_default", 6102, 29, 66, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
        { "blender_279_default", 6102, 928, 44, "ufbxi_read_objects(uc)" },
        { "blender_279_default", 6102, 537, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
        { "blender_279_default", 6102, 70409, 255, "ufbxi_read_connections(uc)" },
        { "blender_279_default", 6102, 586, 255, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
        { "blender_279_default", 6102, 70669, 0, "ufbxi_read_takes(uc)" },
        { "blender_279_default", 6102, 1, 60, "ufbxi_read_root(uc)" },
};
