...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 497, "str || length == 0" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 16, 0, "str" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 17, "uc->read_fn" },
	{ "maya_cube_7400_binary", -1, 0, 0, 0, 13681, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21265, "uc->read_fn" },
	{ "maya_cube_6100_binary", -1, 0, 0, 0, 10721, "val" },
	{ "maya_cube_6100_binary", -1, 0, 0, 0, 7057, "val" },
	{ "maya_cube_6100_binary", -1, 0, 0, 0, 6801, "val" },
	{ "blender_279_default_7400_binary", -1, 0, 1009, 0, 0, "data" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 161, "header" },
	...
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 21153, "res == (ptrdiff_t)decoded_data_size" },
	{ "maya_cube_6100_binary", -1, 0, 273, 0, 0, "arr_data" },
	{ "maya_cube_6100_binary", -1, 0, 0, 0, 6801, "ufbxi_binary_parse_multivalue_array(uc, dst_type, arr_d..." },
	{ "blender_279_default_7400_binary", -1, 0, 48, 0, 0, "vals" },
	{ "blender_279_default_7400_binary", -1, 0, 0, 0, 97, "data" },
	{ "blender_279_default_7400_binary", -1, 0, 389, 0, 0, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
	{ "maya_cube_7400_binary", -1, 0, 0, 0, 13681, "ufbxi_skip_bytes(uc, encoded_size)" },
	{ "maya_game_sausage_6100_binary", -1, 0, 0, 0, 42449, "ufbxi_skip_bytes(uc, values_end_offset - offset)" },
	{ "blender_279_default_7400_binary", -1, 0, 48, 0, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 11756, "end == token->str_data + token->str_len - 1" },
	{ "maya_cone_6100_ascii", -1, 0, 0, 0, 5525, "end == token->str_data + token->str_len - 1" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 481, "c != '\\0'" },
	{ "blender_279_default_6100_ascii", -1, 0, 19, 0, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 251, "depth == 0" },
	{ "blender_279_default_6100_ascii", -1, 0, 19, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4763, 0, 0, "name" },
	{ "blender_279_default_6100_ascii", -1, 0, 32, 0, 0, "node" },
	{ "blender_279_default_6100_ascii", -1, 0, 1281, 0, 0, "arr" },
	...
	{ "maya_cube_7100_ascii", -1, 0, 0, 0, 8925, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
	{ "maya_cube_7100_ascii", -1, 0, 0, 0, 9076, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
	{ "maya_cube_7100_ascii", -1, 0, 0, 0, 8993, "ufbxi_ascii_accept(uc, '}')" },
	{ "blender_279_default_6100_ascii", -1, 0, 4722, 0, 0, "arr_data" },
	{ "blender_279_default_6100_ascii", -1, 0, 33, 0, 0, "node->vals" },
	{ "blender_279_default_6100_ascii", -1, 0, 32, 0, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 48, 0, 0, "ufbxi_ascii_parse_node(uc, 0, state, p_end, buf, true)" },
	{ "blender_279_default_7400_binary", -1, 0, 48, 0, 0, "ufbxi_binary_parse_node(uc, 0, state, p_end, buf, true)" },
	{ "blender_279_default_6100_ascii", -1, 0, 16, 0, 0, "ufbxi_ascii_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, &..." },
	{ "blender_279_default_7400_binary", -1, 0, 16, 0, 0, "ufbxi_binary_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, ..." },
	{ "blender_279_default_6100_ascii", -1, 0, 18, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
	{ "blender_279_default_6100_ascii", -1, 0, 4656, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
	{ "blender_279_default_6100_ascii", -1, 0, 4676, 0, 0, "node->children" },
	{ "blender_279_default_6100_ascii", -1, 0, 48, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 32, 0, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
	{ "blender_279_default_7400_binary", -1, 0, 145, 0, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 80, 0, 0, "ufbxi_parse_toplevel_child(uc, &object)" },
	{ "blender_279_default_7400_binary", -1, 0, 397, 0, 0, "tmpl" },
	{ "blender_279_default_7400_binary", -1, 0, 416, 0, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
	{ "blender_279_default_7400_binary", -1, 0, 859, 0, 0, "uc->templates" },
	{ "blender_279_default_6100_ascii", -1, 0, 1384, 0, 0, "mesh" },
	{ "maya_cube_7100_ascii", -1, 0, 0, 0, 8909, "vertices && indices" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 1384, 0, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
	...
	{ "maya_interpolation_modes_7500_ascii", -1, 0, 0, 0, 13315, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 224, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 40, 0, "ufbxi_split_type_and_name(uc, type_and_name, &type_str,..." },
	{ "blender_279_default_7400_binary", -1, 0, 896, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
	{ "blender_279_default_6100_ascii", -1, 0, 257, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
	{ "blender_279_default_6100_ascii", -1, 0, 334, 0, 0, "ufbxi_read_model(uc, node, &object)" },
	{ "blender_279_default_7400_binary", -1, 0, 1054, 0, 0, "ufbxi_read_geometry(uc, node, &object)" },
	...
	{ "maya_interpolation_modes_7500_binary", -1, 0, 859, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5234, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 5264, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5265, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5248, 0, 0, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5234, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
	{ "blender_279_default_6100_ascii", -1, 0, 5232, 0, 0, "layer" },
	{ "blender_279_default_6100_ascii", -1, 0, 0, 0, 74417, "ufbxi_get_val1(node, \"S\", &layer->name)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5234, 0, 0, "ufbxi_read_take_object(uc, child, layer_id)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4704, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5232, 0, 0, "ufbxi_read_take(uc, node)" },
	{ "blender_279_default_7400_binary", -1, 0, 1221, 0, 0, "uc->attributes" },
	{ "blender_279_sausage_6100_ascii", -1, 0, 5117, 0, 0, "uc->skin_deformers" },
	{ "blender_279_default_6100_ascii", -1, 0, 4688, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
	{ "maya_interpolation_modes_7500_ascii", -1, 0, 0, 0, 17377, "ufbxi_get_val_at(node, 3, 'C', (char**)&prop)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 16, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
	{ "blender_279_default_6100_ascii", -1, 0, 32, 0, 0, "ufbxi_read_header_extension(uc)" },
	{ "blender_279_default_7400_binary", -1, 0, 112, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
	{ "blender_279_default_7400_binary", -1, 0, 145, 0, 0, "ufbxi_read_document(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 49, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
	{ "blender_279_default_6100_ascii", -1, 0, 51, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
	{ "blender_279_default_6100_ascii", -1, 0, 80, 0, 0, "ufbxi_read_definitions(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 88, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
	{ "blender_279_default_6100_ascii", -1, 0, 224, 0, 0, "ufbxi_read_objects(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4656, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4688, 0, 0, "ufbxi_read_connections(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4690, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
	{ "blender_279_default_6100_ascii", -1, 0, 4704, 0, 0, "ufbxi_read_takes(uc)" },
	...
	{ "blender_279_default_6100_ascii", -1, 0, 48, 0, 0, "ufbxi_read_root(uc)" },
	{ "blender_279_default_6100_ascii", -1, 0, 5317, 0, 0, "ufbxi_finalize_scene(uc)" },
        ...
        { "blender_279_default_7400_binary", -1, 0, 0, 0, 21393, "uc->read_fn" },
        { "maya_cube_6100_binary", -1, 0, 0, 0, 10753, "val" },
        ...
        { "blender_279_default_7400_binary", -1, 0, 0, 0, 193, "header" },
        ...
        { "blender_279_default_7400_binary", -1, 0, 0, 0, 21393, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
        ...
        { "blender_279_default_6100_ascii", -1, 0, 33, 0, 0, "node" },
        { "blender_279_default_6100_ascii", -1, 0, 1612, 0, 0, "arr" },
        ...
        { "blender_279_default_6100_ascii", -1, 0, 5088, 0, 0, "v" },
        { "maya_auto_clamp_7100_ascii", -1, 0, 1121, 0, 0, "v" },
        { "blender_279_default_6100_ascii", -1, 0, 5089, 0, 0, "v" },
        { "blender_279_default_6100_ascii", -1, 0, 5090, 0, 0, "v" },
        ...
        { "blender_279_default_6100_ascii", -1, 0, 5091, 0, 0, "arr_data" },
        ...
        { "maya_interpolation_modes_7500_binary", -1, 0, 1232, 0, 0, "prop" },
        ...
        { "maya_interpolation_modes_7500_binary", -1, 0, 1232, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
        { "blender_279_sausage_6100_ascii", -1, 0, 5257, 0, 0, "ufbxi_read_deformer(uc, node, &object)" },
        { "blender_279_default_6100_ascii", -1, 0, 5697, 0, 0, "curve" },
        { "maya_game_sausage_6100_binary_combined", -1, 0, 4120, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_ANIM_CURVE,..." },
        { "blender_279_default_6100_ascii", -1, 0, 5696, 0, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
        ...
        { "blender_279_default_6100_ascii", -1, 0, 5669, 0, 0, "prop" },
        ...
        { "blender_279_default_6100_ascii", -1, 0, 5057, 0, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
        { "blender_279_default_6100_ascii", -1, 0, 14, 0, 0, "model" },
