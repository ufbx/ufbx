...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "blender_279_default", 6102, -1, 0, 16, 0, "ator->allocs_left > 1" },
        { "blender_279_default", 6102, -1, 0, 54, 0, "ator->allocs_left > 1" },
        { "maya_interpolation_modes", 6101, 16930, 255, 0, 0, "size <= UFBXI_MAX_ALLOCATION_SIZE" },
        { "blender_279_default", 6102, -1, 0, 50, 0, "data" },
        { "blender_279_default", 6102, -1, 0, 24, 0, "ufbxi_map_grow(&uc->string_map, ufbx_string, 16)" },
        { "blender_279_default", 6102, -1, 0, 0, 64, "dst" },
        { "blender_279_default", 7401, 331, 0, 0, 0, "str || length == 0" },
        { "blender_279_default", 6102, -1, 0, 9, 0, "str" },
        ...
        { "blender_279_default", 7401, -1, 0, 1007, 0, "data" },
        { "blender_279_default", 7401, 24, 255, 0, 0, "num_values64 <= (uint64_t)uc->opts.max_node_values" },
        { "blender_279_default", 7401, -1, 0, 16, 0, "node" },
        { "blender_279_default", 7401, -1, 0, 24, 0, "name" },
        { "blender_279_default", 7401, -1, 0, 1019, 0, "arr" },
        { "blender_279_default", 7401, 21085, 255, 0, 0, "size <= uc->opts.max_array_size" },
        { "blender_279_default", 7401, -1, 0, 1007, 0, "arr_data" },
        { "blender_279_default", 7401, 21086, 0, 0, 0, "encoded_size == decoded_data_size" },
        { "blender_279_default", 7401, -1, 0, 1002, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->read_buffer, &uc->..." },
        ...
        { "blender_279_default", 7401, -1, 0, 66, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 17, 0, "ufbxi_grow_array(&uc->ator_tmp, &token->str_data, &toke..." },
        { "blender_279_default", 6102, -1, 0, 11, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "blender_279_default", 6102, -1, 0, 17, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        ...
        { "blender_279_default", 6102, -1, 0, 24, 0, "name" },
        { "blender_279_default", 6102, -1, 0, 32, 0, "node" },
        { "blender_279_default", 6102, -1, 0, 1250, 0, "arr" },
        { "blender_279_default", 6102, -1, 0, 0, 145, "ufbxi_push_string_place_str(uc, &v->s)" },
        { "blender_279_default", 6102, -1, 0, 0, 272, "v" },
        { "maya_interpolation_modes", 7502, -1, 0, 848, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 816, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4724, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 817, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4725, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4726, 0, "v" },
        ...
        { "blender_279_default", 6102, -1, 0, 4727, 0, "arr_data" },
        { "blender_279_default", 6102, -1, 0, 96, 0, "node->vals" },
        { "blender_279_default", 6102, 251, 255, 0, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        { "blender_279_default", 6102, -1, 0, 48, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 11, 0, "ufbxi_ascii_next_token(uc, &uc->ascii.token)" },
        ...
        { "blender_279_default", 6102, -1, 0, 16, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
        { "blender_279_default", 6102, 73408, 255, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        { "blender_279_default", 6102, -1, 0, 4664, 0, "node->children" },
        ...
        { "blender_279_default", 6102, -1, 0, 7, 0, "ufbxi_map_grow(&uc->prop_type_map, ufbxi_prop_type_name..." },
        { "blender_279_default", 6102, -1, 0, 0, 1, "defs" },
        { "blender_279_default", 6102, -1, 0, 0, 3, "defs->props" },
        { "blender_279_default", 6102, -1, 0, 9, 0, "ufbxi_push_string_place_str(uc, &prop->name)" },
        { "blender_279_default", 6102, -1, 0, 0, 97, "ufbxi_push_string_place_str(uc, &prop->value_str)" },
        { "blender_279_default", 6102, -1, 0, 1384, 0, "conn" },
        { "blender_279_default", 6102, -1, 0, 49, 0, "ufbxi_map_grow(&uc->connectable_map, ufbxi_connectable,..." },
        ...
        { "blender_279_default", 7401, -1, 0, 158, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        ...
        { "blender_279_default", 6102, -1, 0, 331, 0, "dst->props" },
        { "blender_279_default", 6102, -1, 0, 331, 0, "ufbxi_sort_properties(uc, &left, &uc->tmp_sort)" },
        { "blender_279_default", 6102, -1, 0, 333, 0, "ufbxi_sort_properties(uc, &right, &uc->tmp_sort)" },
        { "blender_279_default", 6102, -1, 0, 331, 0, "ufbxi_merge_properties(uc, dst, &left, &right, buf)" },
        { "blender_279_default", 6102, -1, 0, 0, 416, "dst->props" },
        { "blender_279_default", 6102, -1, 0, 257, 0, "prop" },
        { "blender_279_default", 6102, 1106, 0, 0, 0, "ufbxi_read_property(uc, prop_node, prop, version)" },
        { "blender_279_default", 6102, -1, 0, 329, 0, "props->props" },
        { "blender_279_default", 6102, -1, 0, 331, 0, "ufbxi_sort_properties(uc, props, buf)" },
        { "blender_279_default", 6102, 645, 255, 0, 0, "ufbxi_parse_toplevel_child(uc, &object)" },
        { "blender_279_default", 7401, -1, 0, 395, 0, "tmpl" },
        ...
        { "blender_279_default", 7401, -1, 0, 857, 0, "uc->templates" },
        ...
        { "blender_279_default", 6102, -1, 0, 1382, 0, "mesh" },
        ...
        { "blender_279_default", 6102, -1, 0, 1380, 0, "mesh" },
        { "blender_279_default", 6102, 20377, 0, 0, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
        { "blender_279_default", 6102, -1, 0, 1384, 0, "ufbxi_add_connection(uc, object->id, geom_obj.id, NULL)" },
        { "blender_279_default", 6102, -1, 0, 1091, 0, "light" },
        { "blender_279_default", 7401, -1, 0, 896, 0, "attr" },
        { "maya_pivots", 7501, -1, 0, 825, 0, "layer" },
        { "maya_interpolation_modes", 7501, -1, 0, 855, 0, "curve" },
        ...
        { "maya_interpolation_modes", 7501, -1, 0, 891, 0, "prop" },
        ...
        { "blender_279_default", 7401, -1, 0, 896, 0, "ufbxi_read_node_attribute(uc, node, &object)" },
        { "maya_pivots", 7501, -1, 0, 825, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, 24310, 255, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, -1, 0, 891, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
        { "blender_279_default", 6102, -1, 0, 5234, 0, "curve" },
        { "blender_279_default", 6102, -1, 0, 5235, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
        ...
        { "blender_279_default", 6102, -1, 0, 5240, 0, "prop" },
        { "blender_279_default", 6102, -1, 0, 5232, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
        { "blender_279_default", 6102, -1, 0, 5233, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
        ...
        { "blender_279_default", 6102, -1, 0, 5218, 0, "layer" },
        ...
        { "blender_279_default", 7401, -1, 0, 1218, 0, "uc->attributes" },
        ...
        { "blender_279_default", 6102, -1, 0, 4674, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
        { "blender_279_default", 6102, -1, 0, 12, 0, "model" },
        ...
        { "blender_279_default", 6102, -1, 0, 49, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        ...
        { "blender_279_default", 7401, -1, 0, 1243, 0, "ufbxi_merge_properties(uc, props, props->defaults, prop..." },
        ...
        { "blender_279_default", 6102, -1, 0, 5303, 0, "conns" },
        { "blender_279_default", 7401, -1, 0, 1242, 0, "uc->geometries" },
        ...
        { "blender_279_default", 6102, -1, 0, 7, 0, "ufbxi_load_maps(uc)" },
        { "blender_279_default", 6102, -1, 0, 9, 0, "ufbxi_load_default_props(uc)" },
        { "blender_279_default", 6102, -1, 0, 11, 0, "ufbxi_begin_parse(uc)" },
        { "blender_279_default", 6102, 0, 255, 0, 0, "ufbxi_read_root(uc)" },
        { "blender_279_default", 6102, -1, 0, 5303, 0, "ufbxi_finalize_scene(uc)" },
};
