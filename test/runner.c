...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "blender_279_default", 6102, -1, 0, 16, 0, 0, "ator->allocs_left > 1" },
        { "blender_279_default", 6102, -1, 0, 54, 0, 0, "ator->allocs_left > 1" },
        { "maya_interpolation_modes", 6101, 16930, 255, 0, 0, 0, "size <= UFBXI_MAX_ALLOCATION_SIZE" },
        { "blender_279_default", 6102, -1, 0, 50, 0, 0, "data" },
        { "blender_279_default", 6102, -1, 0, 24, 0, 0, "ufbxi_map_grow(&uc->string_map, ufbx_string, 16)" },
        { "blender_279_default", 6102, -1, 0, 0, 48, 0, "dst" },
        { "blender_279_default", 7401, 331, 0, 0, 0, 0, "str || length == 0" },
        { "blender_279_default", 6102, -1, 0, 9, 0, 0, "str" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 17, "uc->read_fn" },
        { "blender_279_default", 7401, 36, 255, 0, 0, 0, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21265, "uc->read_fn" },
        ...
        { "blender_279_default", 7401, -1, 0, 1007, 0, 0, "data" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 65, "header" },
        ...
        { "blender_279_default", 7401, -1, 0, 24, 0, 0, "name" },
        { "blender_279_default", 7401, -1, 0, 1001, 0, 0, "arr" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21081, "data" },
        { "blender_279_default", 7401, 21085, 255, 0, 0, 0, "size <= uc->opts.max_array_size" },
        { "blender_279_default", 7401, -1, 0, 1007, 0, 0, "arr_data" },
        { "blender_279_default", 7401, 21086, 0, 0, 0, 0, "encoded_size == decoded_data_size" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21265, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
        { "blender_279_default", 7401, -1, 0, 1002, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->read_buffer, &uc->..." },
        { "blender_279_default", 7401, 21081, 99, 0, 0, 0, "res == (ptrdiff_t)decoded_data_size" },
        { "blender_279_default", 7401, 21086, 255, 0, 0, 0, "Bad array encoding" },
        { "maya_pivots", 6101, -1, 0, 273, 0, 0, "arr_data" },
        { "blender_279_default", 7401, 21081, 255, 0, 0, 0, "ufbxi_binary_parse_multivalue_array(uc, dst_type, arr_d..." },
        { "blender_279_default", 7401, -1, 0, 17, 0, 0, "vals" },
        { "blender_279_default", 7401, 25664, 255, 0, 0, 0, "data" },
        { "blender_279_default", 7401, 331, 0, 0, 0, 0, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
        { "blender_279_default", 7401, 355, 255, 0, 0, 0, "ufbxi_skip_bytes(uc, encoded_size)" },
        { "blender_279_default", 7401, 31, 255, 0, 0, 0, "Bad values type" },
        { "blender_279_default", 7401, 66, 0, 0, 0, 0, "offset <= values_end_offset" },
        { "blender_279_default", 7401, 36, 255, 0, 0, 0, "ufbxi_skip_bytes(uc, values_end_offset - offset)" },
        { "blender_279_default", 7401, 58, 255, 0, 0, 0, "current_offset == end_offset" },
        { "blender_279_default", 7401, 70, 0, 0, 0, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
        { "blender_279_default", 7401, -1, 0, 66, 0, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 17, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &token->str_data, &toke..." },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "blender_279_default", 6102, -1, 0, 17, 0, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "blender_279_default", 6102, 415, 255, 0, 0, 0, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 1266, 43, 0, 0, 0, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 382, 0, 0, 0, 0, "c != '\\0'" },
        { "blender_279_default", 6102, 382, 0, 0, 0, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "blender_279_default", 6102, 251, 0, 0, 0, 0, "depth == 0" },
        { "blender_279_default", 6102, 0, 255, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "blender_279_default", 6102, -1, 0, 24, 0, 0, "name" },
        { "blender_279_default", 6102, -1, 0, 32, 0, 0, "node" },
        { "blender_279_default", 6102, -1, 0, 1250, 0, 0, "arr" },
        { "blender_279_default", 6102, -1, 0, 0, 145, 0, "ufbxi_push_string_place_str(uc, &v->s)" },
        { "blender_279_default", 6102, -1, 0, 0, 272, 0, "v" },
        { "maya_interpolation_modes", 7502, -1, 0, 848, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 816, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4707, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 817, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4708, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4709, 0, 0, "v" },
        { "maya_pivots", 7502, 8931, 255, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
        { "maya_pivots", 7502, 8935, 255, 0, 0, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 7502, 8941, 255, 0, 0, 0, "ufbxi_ascii_accept(uc, '}')" },
        { "blender_279_default", 6102, -1, 0, 4710, 0, 0, "arr_data" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "node->vals" },
        { "blender_279_default", 6102, 251, 255, 0, 0, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        { "blender_279_default", 6102, -1, 0, 48, 0, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 17, "header" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_ascii_next_token(uc, &uc->ascii.token)" },
        ...
        { "blender_279_default", 6102, -1, 0, 16, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
        { "blender_279_default", 6102, 73408, 255, 0, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        ...
        { "blender_279_default", 7401, 3210, 1, 0, 0, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "blender_279_default", 7401, -1, 0, 158, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        { "blender_279_default", 6102, 1106, 0, 0, 0, 0, "ufbxi_get_val2(node, \"SC\", &prop->name, (char**)&type..." },
        { "blender_279_default", 7401, 3868, 0, 0, 0, 0, "ufbxi_get_val_at(node, val_ix++, 'C', (char**)&subtype_..." },
        ...
        { "blender_279_default", 6102, 1106, 0, 0, 0, 0, "ufbxi_read_property(uc, prop_node, prop, version)" },
        ...
        { "blender_279_default", 7401, 3830, 0, 0, 0, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
        { "blender_279_default", 7401, -1, 0, 857, 0, 0, "uc->templates" },
        { "blender_279_default", 6102, 20867, 77, 0, 0, 0, "data" },
        { "maya_pivots", 6101, 7448, 71, 0, 0, 0, "data->size % num_components == 0" },
        { "blender_279_default", 6102, 20782, 76, 0, 0, 0, "ufbxi_find_val1(node, ufbxi_MappingInformationType, \"C..." },
        { "blender_282_suzanne", 7401, 22994, 0, 0, 0, 0, "Invalid mapping" },
        { "blender_279_default", 6102, 20807, 255, 0, 0, 0, "Invalid mapping" },
        { "blender_279_default", 6102, -1, 0, 1382, 0, 0, "mesh" },
        { "blender_279_default", 6102, 20623, 79, 0, 0, 0, "vertices && indices" },
        { "maya_pivots", 6101, 6763, 23, 0, 0, 0, "vertices->size % 3 == 0" },
        { "blender_279_default", 6102, 20694, 46, 0, 0, 0, "index_data[mesh->num_indices - 1] < 0" },
        ...
        { "blender_279_default", 6102, 20654, 56, 0, 0, 0, "ix < mesh->num_vertices" },
        { "blender_282_suzanne", 7401, -1, 0, 0, 211, 0, "mesh->uv_sets.data" },
        { "blender_279_default", 6102, 20782, 76, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_no..." },
        { "blender_282_suzanne", 7401, 22907, 255, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_uv...." },
        { "blender_279_default", 6102, -1, 0, 1380, 0, 0, "mesh" },
        { "blender_279_default", 6102, 20623, 79, 0, 0, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
        ...
        { "maya_pivots", 7501, -1, 0, 825, 0, 0, "layer" },
        { "maya_interpolation_modes", 7501, -1, 0, 855, 0, 0, "curve" },
        { "maya_interpolation_modes", 7501, 24310, 255, 0, 0, 0, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
        { "maya_interpolation_modes", 7501, 24387, 255, 0, 0, 0, "values = ufbxi_find_array(node, ufbxi_KeyValueFloat, 'r..." },
        { "maya_interpolation_modes", 7501, 24528, 255, 0, 0, 0, "attr_flags = ufbxi_find_array(node, ufbxi_KeyAttrFlags,..." },
        ...
        { "maya_interpolation_modes", 7502, 13357, 43, 0, 0, 0, "times->size == values->size" },
        { "maya_interpolation_modes", 7502, 14126, 43, 0, 0, 0, "attr_flags->size == refs->size" },
        { "maya_interpolation_modes", 7502, 15551, 43, 0, 0, 0, "attrs->size == refs->size * 4u" },
        { "maya_interpolation_modes", 7501, -1, 0, 0, 267, 0, "keys" },
        { "maya_interpolation_modes", 7501, 25023, 0, 0, 0, 0, "refs_left >= 0" },
        { "maya_interpolation_modes", 7501, -1, 0, 891, 0, 0, "prop" },
        { "maya_pivots", 7501, -1, 0, 0, 260, 0, "ufbxi_push_string_place_str(uc, type)" },
        ...
        { "blender_279_default", 7401, 18278, 0, 0, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
        { "blender_279_default", 6102, 1106, 0, 0, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
        { "blender_279_default", 6102, 20623, 79, 0, 0, 0, "ufbxi_read_model(uc, node, &object)" },
        { "blender_279_default", 7401, 21028, 255, 0, 0, 0, "ufbxi_read_geometry(uc, node, &object)" },
        { "blender_279_default", 7401, -1, 0, 896, 0, 0, "ufbxi_read_node_attribute(uc, node, &object)" },
        { "maya_pivots", 7501, -1, 0, 825, 0, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, 24310, 255, 0, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, -1, 0, 891, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
        { "blender_279_default", 6102, -1, 0, 5234, 0, 0, "curve" },
        { "blender_279_default", 6102, -1, 0, 5235, 0, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
        { "blender_279_default", 6102, 74781, 74, 0, 0, 0, "ufbxi_find_val1(node, ufbxi_KeyCount, \"Z\", &num_keys)" },
        { "blender_279_default", 6102, -1, 0, 0, 448, 0, "curve->keyframes.data" },
        { "maya_interpolation_modes", 6101, 16936, 0, 0, 0, 0, "data_end - data >= 2" },
        { "maya_interpolation_modes", 6101, 16936, 73, 0, 0, 0, "data_end - data >= 4" },
        { "blender_279_default", 6102, 74843, 75, 0, 0, 0, "Unknown key mode" },
        { "blender_279_default", 6102, 74791, 50, 0, 0, 0, "data_end - data >= 2" },
        { "blender_279_default", 6102, 74791, 48, 0, 0, 0, "data == data_end" },
        { "blender_279_default", 6102, 74694, 0, 0, 0, 0, "ufbxi_get_val1(child, \"C\", (char**)&old_name)" },
        { "blender_279_default", 6102, 74781, 74, 0, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, -1, 0, 5220, 0, 0, "prop" },
        { "blender_279_default", 6102, -1, 0, 5232, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
        { "blender_279_default", 6102, -1, 0, 5233, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
        { "blender_279_default", 6102, 74781, 74, 0, 0, 0, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
        { "maya_interpolation_modes", 6101, 16706, 0, 0, 0, 0, "ufbxi_get_val1(node, \"c\", (char**)&type_and_name)" },
        { "blender_279_default", 6102, 74694, 0, 0, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, -1, 0, 5218, 0, 0, "layer" },
        { "blender_279_default", 6102, 74417, 255, 0, 0, 0, "ufbxi_get_val1(node, \"S\", &layer->name)" },
        { "blender_279_default", 6102, 74694, 0, 0, 0, 0, "ufbxi_read_take_object(uc, child, layer_id)" },
        ...
        { "blender_279_default", 6102, -1, 0, 12, 0, 0, "model" },
        ...
        { "blender_279_default", 7401, 58, 0, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
        { "blender_279_default", 7401, 3210, 1, 0, 0, 0, "ufbxi_read_document(uc)" },
        { "blender_279_default", 6102, -1, 0, 49, 0, 0, "ufbxi_add_connectable(uc, UFBXI_CONNECTABLE_MODEL, root..." },
        { "blender_279_default", 6102, 454, 255, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
        { "blender_279_default", 6102, 645, 255, 0, 0, 0, "ufbxi_read_definitions(uc)" },
        { "blender_279_default", 6102, 893, 255, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
        { "blender_279_default", 6102, 997, 255, 0, 0, 0, "ufbxi_read_objects(uc)" },
        { "blender_279_default", 6102, 73300, 255, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
        { "blender_279_default", 6102, 74083, 255, 0, 0, 0, "ufbxi_read_connections(uc)" },
        { "blender_279_default", 6102, 74285, 255, 0, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
        ...
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_begin_parse(uc)" },
