...
int ufbxt_test_fuzz(void *data, size_t size, size_t step, int offset)
{
...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "maya_interpolation_modes", 6101, 16930, 255, "size <= UFBXI_MAX_ALLOCATION_SIZE" },
        { "blender_279_default", 7401, 331, 0, "str || length == 0" },
        { "blender_279_default", 7401, 36, 255, "uc->read_fn" },
        { "blender_279_default", 7401, 36, 255, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
        { "blender_279_default", 7401, 21209, 106, "Bad multivalue array type" },
        { "maya_interpolation_modes", 7501, 24418, 109, "Bad multivalue array type" },
        { "maya_interpolation_modes", 7501, 24765, 103, "Bad multivalue array type" },
        { "blender_279_default", 7401, 21081, 101, "Bad multivalue array type" },
        { "blender_279_default", 7401, 24, 29, "num_values64 <= (uint64_t)uc->opts.max_node_values" },
        { "blender_279_default", 7401, 21085, 255, "size <= uc->opts.max_array_size" },
        { "blender_279_default", 7401, 21086, 0, "encoded_size == decoded_data_size" },
        { "blender_279_default", 7401, 21081, 99, "res == (ptrdiff_t)decoded_data_size" },
        { "blender_279_default", 7401, 21086, 2, "Bad array encoding" },
        { "blender_279_default", 7401, 21081, 101, "ufbxi_binary_parse_multivalue_array(uc, dst_type, arr_d..." },
        { "blender_279_default", 7401, 25664, 255, "data" },
        { "blender_279_default", 7401, 331, 0, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
        { "blender_279_default", 7401, 355, 255, "ufbxi_skip_bytes(uc, encoded_size)" },
        { "blender_279_default", 7401, 31, 1, "Bad values type" },
        { "blender_279_default", 7401, 66, 4, "offset <= values_end_offset" },
        { "blender_279_default", 7401, 36, 255, "ufbxi_skip_bytes(uc, values_end_offset - offset)" },
        { "blender_279_default", 7401, 58, 93, "current_offset == end_offset" },
        { "blender_279_default", 7401, 70, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
        { "blender_279_default", 6102, 103, 0, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 96, 0, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, 382, 0, "c != '\\0'" },
        { "blender_279_default", 6102, 382, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "blender_279_default", 6102, 96, 0, "ufbxi_ascii_next_token(uc, &ua->token)" },
        { "blender_279_default", 6102, 0, 60, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 7502, 8931, 0, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
        { "maya_pivots", 7502, 8935, 11, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_pivots", 7502, 8941, 33, "ufbxi_ascii_accept(uc, '}')" },
        { "blender_279_default", 6102, 251, 14, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        { "blender_279_default", 6102, 180, 33, "ufbxi_ascii_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 7401, 35, 1, "ufbxi_binary_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 6102, 0, 60, "ufbxi_ascii_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, &..." },
        { "blender_279_default", 7401, 24, 29, "ufbxi_binary_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, ..." },
        { "blender_279_default", 6102, 73408, 14, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        { "blender_279_default", 6102, 180, 33, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
        { "blender_279_default", 6102, 180, 33, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "blender_279_default", 7401, 3210, 1, "ufbxi_parse_toplevel_child(uc, &child)" },
        { "blender_279_default", 6102, 1106, 0, "ufbxi_get_val2(node, \"SC\", &prop->name, (char**)&type..." },
        { "blender_279_default", 7401, 3868, 0, "ufbxi_get_val_at(node, val_ix++, 'C', (char**)&subtype_..." },
        { "blender_279_default", 6102, 1106, 0, "ufbxi_read_property(uc, prop_node, prop, version)" },
        { "blender_279_default", 6102, 645, 33, "ufbxi_parse_toplevel_child(uc, &object)" },
        { "blender_279_default", 7401, 3762, 0, "ufbxi_get_val1(props, \"S\", &tmpl->sub_type)" },
        { "blender_279_default", 7401, 3698, 0, "ufbxi_get_val1(object, \"C\", (char**)&tmpl->type)" },
        { "blender_279_default", 7401, 3830, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
        { "blender_279_default", 6102, 20743, 0, "data" },
        { "maya_pivots", 6101, 7448, 71, "data->size % num_components == 0" },
        { "blender_279_default", 6102, 20782, 78, "ufbxi_find_val1(node, ufbxi_MappingInformationType, \"C..." },
        { "blender_282_suzanne", 7401, 22994, 14, "Invalid mapping" },
        { "blender_279_default", 6102, 20807, 67, "Invalid mapping" },
        { "blender_279_default", 6102, 20377, 0, "vertices && indices" },
        { "maya_pivots", 6101, 6763, 23, "vertices->size % 3 == 0" },
        { "blender_279_default", 6102, 20644, 0, "index_data[mesh->num_indices - 1] < 0" },
        { "blender_279_default", 7401, 21349, 255, "index_ix >= 0 && (size_t)index_ix < mesh->num_indices" },
        { "blender_279_default", 6102, 20654, 56, "ix < mesh->num_vertices" },
        { "blender_279_default", 6102, 20743, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_no..." },
        { "blender_282_suzanne", 7401, 22907, 255, "ufbxi_read_vertex_element(uc, mesh, n, &set->vertex_uv...." },
        { "blender_279_default", 6102, 20377, 0, "ufbxi_read_geometry(uc, node, &geom_obj)" },
        { "maya_interpolation_modes", 7501, 24310, 255, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
        { "maya_interpolation_modes", 7501, 24387, 255, "values = ufbxi_find_array(node, ufbxi_KeyValueFloat, 'r..." },
        { "maya_interpolation_modes", 7501, 24528, 255, "attr_flags = ufbxi_find_array(node, ufbxi_KeyAttrFlags,..." },
        { "maya_interpolation_modes", 7501, 24627, 255, "attrs = ufbxi_find_array(node, ufbxi_KeyAttrDataFloat, ..." },
        { "maya_interpolation_modes", 7501, 24724, 255, "refs = ufbxi_find_array(node, ufbxi_KeyAttrRefCount, 'i..." },
        { "maya_interpolation_modes", 7502, 13357, 43, "times->size == values->size" },
        { "maya_interpolation_modes", 7502, 14126, 43, "attr_flags->size == refs->size" },
        { "maya_interpolation_modes", 7502, 15551, 43, "attrs->size == refs->size * 4u" },
        { "maya_interpolation_modes", 7501, 25023, 0, "refs_left >= 0" },
        { "blender_279_default", 6102, 1011, 0, "ufbxi_check_string(*type)" },
        { "blender_279_default", 7401, 18187, 0, "ufbxi_check_string(*name)" },
        { "blender_279_default", 6102, 997, 33, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, 1011, 0, "ufbxi_split_type_and_name(uc, type_and_name, &type_str,..." },
        { "blender_279_default", 7401, 18278, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
        { "blender_279_default", 6102, 1106, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->res..." },
        { "blender_279_default", 6102, 20377, 0, "ufbxi_read_model(uc, node, &object)" },
        { "blender_279_default", 7401, 21028, 255, "ufbxi_read_geometry(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, 24310, 255, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "blender_279_default", 6102, 74781, 76, "ufbxi_find_val1(node, ufbxi_KeyCount, \"Z\", &num_keys)" },
        { "maya_interpolation_modes", 6101, 16930, 255, "curve->keyframes.data" },
        { "maya_interpolation_modes", 6101, 16936, 0, "data_end - data >= 2" },
        { "blender_279_default", 6102, 74843, 0, "data_end - data >= 3" },
        { "maya_interpolation_modes", 6101, 16936, 73, "data_end - data >= 4" },
        { "blender_279_default", 6102, 74843, 77, "Unknown key mode" },
        { "blender_279_default", 6102, 74791, 50, "data_end - data >= 2" },
        { "blender_279_default", 6102, 74791, 48, "data == data_end" },
        { "blender_279_default", 6102, 74694, 0, "ufbxi_get_val1(child, \"C\", (char**)&old_name)" },
        { "blender_279_default", 6102, 74781, 76, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, 74781, 76, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
        { "blender_279_default", 6102, 74618, 0, "ufbxi_get_val1(node, \"c\", (char**)&type_and_name)" },
        { "blender_279_default", 6102, 74694, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, 74417, 33, "ufbxi_get_val1(node, \"S\", &layer->name)" },
        { "blender_279_default", 6102, 74618, 0, "ufbxi_read_take_object(uc, child, layer_id)" },
        { "blender_279_default", 6102, 74380, 33, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, 74417, 33, "ufbxi_read_take(uc, node)" },
        { "blender_279_default", 6102, 74083, 33, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, 74100, 80, "ufbxi_get_val_at(node, 3, 'C', (char**)&prop)" },
        { "blender_279_default", 6102, 0, 60, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
        { "blender_279_default", 6102, 180, 33, "ufbxi_read_header_extension(uc)" },
        { "blender_279_default", 6102, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
        { "blender_279_default", 7401, 3210, 1, "ufbxi_read_document(uc)" },
        { "blender_279_default", 6102, 12, 0, "ufbxi_parse_toplevel(uc, ufbxi_Definitions)" },
        { "blender_279_default", 6102, 645, 33, "ufbxi_read_definitions(uc)" },
        { "blender_279_default", 6102, 469, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
        { "blender_279_default", 6102, 997, 33, "ufbxi_read_objects(uc)" },
        { "blender_279_default", 6102, 897, 0, "ufbxi_parse_toplevel(uc, ufbxi_Connections)" },
        { "blender_279_default", 6102, 74083, 33, "ufbxi_read_connections(uc)" },
        { "blender_279_default", 6102, 73304, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
        { "blender_279_default", 6102, 74380, 33, "ufbxi_read_takes(uc)" },
        { "blender_279_default", 6102, 0, 60, "ufbxi_read_root(uc)" },
};
