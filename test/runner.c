...
static const ufbxt_fuzz_check g_fuzz_checks[] = {
        { "maya_cube", 7101, 16067, 15, 0, 0, 0, "total <= UFBXI_MAX_ALLOCATION_SIZE" },
        { "blender_279_default", 6102, -1, 0, 225, 0, 0, "ator->allocs_left > 1" },
        { "maya_rotation_order", 7501, 23724, 15, 0, 0, 0, "total <= UFBXI_MAX_ALLOCATION_SIZE" },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 32, 0, "dst" },
        { "blender_279_default", 7401, 35, 5, 0, 0, 0, "str || length == 0" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "str" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 17, "uc->read_fn" },
        { "blender_279_default", 7401, 35, 233, 0, 0, 0, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21222, "uc->read_fn" },
        { "maya_cube", 6101, -1, 0, 0, 0, 10705, "val" },
        { "maya_cube", 6101, 10670, 255, 0, 0, 0, "Bad multivalue array type" },
        ...
        { "blender_279_default", 7401, -1, 0, 0, 0, 177, "name" },
        { "blender_279_default", 7401, -1, 0, 0, 224, 0, "name" },
        { "blender_279_default", 7401, -1, 0, 1522, 0, 0, "arr" },
        ...
        { "maya_cube", 7101, 16067, 15, 0, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->convert_buffer, &u..." },
        { "blender_279_default", 7401, 21086, 0, 0, 0, 0, "encoded_size == decoded_data_size" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21222, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
        ...
        { "blender_279_default", 7401, -1, 0, 84, 0, 0, "node->children" },
        ...
        { "blender_279_default", 6102, -1, 0, 224, 0, 0, "node" },
        { "blender_279_default", 6102, -1, 0, 1592, 0, 0, "arr" },
        { "blender_279_default", 6102, -1, 0, 0, 240, 0, "ufbxi_push_string_place_str(uc, &v->s)" },
        { "maya_cube", 6102, -1, 0, 0, 768, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 0, 464, 0, "v" },
        { "maya_interpolation_modes", 7502, -1, 0, 1168, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 1136, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 5104, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 1121, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 5105, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 5072, 0, 0, "v" },
        ...
        { "blender_279_default", 6102, -1, 0, 5073, 0, 0, "arr_data" },
        { "blender_279_default", 6102, -1, 0, 48, 0, 0, "node->vals" },
        ...
        { "blender_279_default", 6102, -1, 0, 5022, 0, 0, "node->children" },
        ...
        { "blender_279_default", 6102, -1, 0, 9, 0, 0, "pooled" },
        { "blender_279_default", 6102, -1, 0, 0, 1, 0, "defs" },
        { "blender_279_default", 6102, -1, 0, 0, 3, 0, "defs->props" },
        { "blender_279_default", 6102, -1, 0, 0, 32, 0, "ufbxi_push_string_place_str(uc, &prop->name)" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_push_string_place_str(uc, &prop->value_str)" },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 642, 0, "dst->props" },
        { "blender_279_default", 6102, -1, 0, 480, 0, 0, "prop" },
        ...
        { "blender_279_default", 7401, -1, 0, 1345, 0, 0, "uc->templates" },
        ...
        { "maya_cube", 6101, 10572, 255, 0, 0, 0, "arr" },
        ...
        { "blender_279_default", 7401, -1, 0, 0, 595, 0, "edges" },
        { "blender_279_default", 7401, 21349, 255, 0, 0, 0, "index_ix >= 0 && (size_t)index_ix < mesh->num_indices" },
        { "blender_279_default", 6102, -1, 0, 0, 572, 0, "mesh->faces" },
        { "blender_279_default", 6102, 20377, 59, 0, 0, 0, "ix < mesh->num_vertices" },
        { "maya_cube", 6101, -1, 0, 802, 0, 0, "binormals" },
        { "maya_cube", 6101, -1, 0, 803, 0, 0, "tangents" },
        { "blender_282_suzanne", 7401, -1, 0, 0, 368, 0, "mesh->uv_sets.data" },
        { "maya_color_sets", 6101, -1, 0, 0, 333, 0, "mesh->color_sets.data" },
        { "blender_279_default", 6102, 20743, 125, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_no..." },
        { "maya_cube", 6101, 8133, 159, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.dat..." },
        { "maya_cube", 6101, 9008, 159, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &layer->elem.dat..." },
        ...
        { "maya_cone", 6101, 15988, 46, 0, 0, 0, "ufbxi_read_vertex_element(uc, mesh, n, &mesh->vertex_cr..." },
        { "maya_cone", 6101, 15491, 146, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
        { "maya_cone", 6101, 15571, 255, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->edge_crease, n, u..." },
        { "maya_cube", 6101, 10494, 241, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
        { "maya_cube", 6101, 10572, 255, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->edge_smoothing, n..." },
        { "blender_279_ball", 6102, 18380, 125, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->face_smoothing, n..." },
        { "blender_279_default", 6102, 21651, 125, 0, 0, 0, "ufbxi_find_val1(n, ufbxi_MappingInformationType, \"C\",..." },
        { "blender_279_ball", 6102, 18706, 125, 0, 0, 0, "ufbxi_read_truncated_array(uc, &mesh->face_material, n,..." },
        { "blender_279_default", 6102, 21723, 125, 0, 0, 0, "arr && arr->size >= 1" },
        { "blender_279_default", 6102, -1, 0, 4947, 0, 0, "material" },
        { "blender_279_default", 6102, -1, 0, 0, 643, 0, "ufbxi_merge_properties(uc, &material->props, material->..." },
        ...
        { "blender_279_default", 7401, -1, 0, 1385, 0, 0, "attr" },
        { "maya_cube", 7101, -1, 0, 1120, 0, 0, "layer" },
        { "maya_interpolation_modes", 7501, -1, 0, 1175, 0, 0, "curve" },
        ...
        { "maya_interpolation_modes", 7501, -1, 0, 0, 465, 0, "keys" },
        { "maya_interpolation_modes", 7501, 25010, 102, 0, 0, 0, "refs_left >= 0" },
        { "maya_interpolation_modes", 7501, -1, 0, 1232, 0, 0, "prop" },
        { "maya_cube", 7101, -1, 0, 0, 449, 0, "ufbxi_push_string_place_str(uc, type)" },
        { "blender_279_default", 6102, -1, 0, 0, 592, 0, "ufbxi_push_string_place_str(uc, name)" },
        ...
        { "blender_279_default", 6102, -1, 0, 4947, 0, 0, "ufbxi_read_material(uc, node, &object)" },
        { "blender_279_default", 7401, -1, 0, 1385, 0, 0, "ufbxi_read_node_attribute(uc, node, &object)" },
        { "maya_cube", 7101, -1, 0, 1120, 0, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, 24256, 248, 0, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, -1, 0, 1232, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
        { "blender_279_default", 6102, -1, 0, 5728, 0, 0, "curve" },
        { "blender_279_default", 6102, -1, 0, 5729, 0, 0, "ufbxi_add_connection(uc, parent_id, id, name)" },
        { "blender_279_default", 6102, 74774, 59, 0, 0, 0, "ufbxi_find_val1(node, ufbxi_KeyCount, \"Z\", &num_keys)" },
        { "blender_279_default", 6102, -1, 0, 0, 704, 0, "curve->keyframes.data" },
        ...
        { "blender_279_default", 6102, -1, 0, 5649, 0, 0, "prop" },
        { "blender_279_default", 6102, -1, 0, 5651, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
        { "blender_279_default", 6102, -1, 0, 5653, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
        ...
        { "blender_279_default", 6102, -1, 0, 5648, 0, 0, "layer" },
        ...
        { "blender_279_default", 7401, -1, 0, 1713, 0, 0, "uc->attributes" },
        ...
        { "blender_279_default", 6102, -1, 0, 5040, 0, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 720, 0, "arr->data" },
        { "blender_279_default", 6102, -1, 0, 0, 727, 0, "node->children.data" },
        { "maya_anim_light", 7501, -1, 0, 1236, 0, 0, "ufbxi_merge_properties(uc, props, attr->defaults, props..." },
        { "blender_279_default", 7401, -1, 0, 1746, 0, 0, "ufbxi_merge_properties(uc, props, props->defaults, prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 723, 0, "ufbxi_merge_properties(uc, props, props, attr, &uc->res..." },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 714, 0, "ufbxi_retain_array(uc, sizeof(ufbx_model), &uc->scene.m..." },
        { "blender_279_default", 6102, -1, 0, 0, 715, 0, "ufbxi_retain_array(uc, sizeof(ufbx_mesh), &uc->scene.me..." },
        { "blender_279_default", 6102, -1, 0, 0, 716, 0, "ufbxi_retain_array(uc, sizeof(ufbx_material), &uc->scen..." },
        { "blender_279_default", 6102, -1, 0, 0, 717, 0, "ufbxi_retain_array(uc, sizeof(ufbx_light), &uc->scene.l..." },
        { "blender_279_default", 6102, -1, 0, 0, 718, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_layer), &uc->sc..." },
        { "blender_279_default", 6102, -1, 0, 0, 719, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_prop), &uc->sce..." },
        { "blender_279_default", 6102, -1, 0, 0, 720, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_curve), &uc->sc..." },
        { "blender_279_default", 6102, -1, 0, 5811, 0, 0, "conns" },
        { "blender_279_default", 7401, -1, 0, 1745, 0, 0, "uc->geometries" },
        { "blender_279_default", 6102, -1, 0, 0, 721, 0, "zero_indices && consecutive_indices" },
        { "blender_279_default", 7401, -1, 0, 1748, 0, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 723, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 724, 0, "layer->props.data" },
        { "blender_279_default", 6102, -1, 0, 0, 725, 0, "mesh->materials.data" },
        { "blender_279_default", 6102, -1, 0, 0, 726, 0, "nodes" },
        { "blender_279_default", 6102, -1, 0, 0, 727, 0, "ufbxi_collect_nodes(uc, sizeof(ufbx_model), &nodes, uc-..." },
        { "blender_279_default", 6102, -1, 0, 1, 0, 0, "ufbxi_load_strings(uc)" },
        { "blender_279_default", 6102, -1, 0, 7, 0, 0, "ufbxi_load_maps(uc)" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_load_default_props(uc)" },
        { "blender_279_default", 6102, 0, 46, 0, 0, 0, "ufbxi_begin_parse(uc)" },
        { "blender_279_default", 6102, 0, 255, 0, 0, 0, "ufbxi_read_root(uc)" },
        { "blender_279_default", 6102, -1, 0, 5811, 0, 0, "ufbxi_finalize_scene(uc)" },
        { "blender_279_default", 7401, -1, 0, 0, 646, 0, "imp" },
        { "blender_279_default", 6102, -1, 0, 17, 0, 0, "ator->allocs_left > 1" },
        { "blender_279_default", 6102, -1, 0, 54, 0, 0, "ator->allocs_left > 1" },
        { "blender_279_default", 6102, -1, 0, 2, 0, 0, "data" },
        { "blender_279_default", 6102, -1, 0, 1, 0, 0, "ufbxi_map_grow(&uc->string_map, ufbx_string, 16)" },
        { "blender_279_default", 6102, -1, 0, 0, 16, 0, "dst" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 418, "str || length == 0" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "str" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 1, "uc->read_fn" },
        { "maya_cube", 7401, -1, 0, 0, 0, 13713, "ufbxi_read_bytes(uc, (size_t)to_skip)" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21313, "uc->read_fn" },
        { "maya_cube", 6101, -1, 0, 0, 0, 10721, "val" },
        { "maya_cube", 6101, -1, 0, 0, 0, 7041, "val" },
        { "maya_cube", 6101, -1, 0, 0, 0, 6793, "val" },
        { "blender_279_default", 7401, -1, 0, 1009, 0, 0, "data" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 161, "header" },
        { "blender_279_default", 7401, -1, 0, 128, 0, 0, "node" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 113, "name" },
        { "blender_279_default", 7401, -1, 0, 0, 160, 0, "name" },
        { "blender_279_default", 7401, -1, 0, 1008, 0, 0, "arr" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21217, "data" },
        { "blender_279_default", 7401, -1, 0, 1009, 0, 0, "arr_data" },
        { "maya_cube", 7101, -1, 0, 658, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->convert_buffer, &u..." },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21313, "ufbxi_read_to(uc, decoded_data, encoded_size)" },
        { "blender_279_default", 7401, -1, 0, 1004, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->read_buffer, &uc->..." },
        { "blender_279_default", 7401, -1, 0, 0, 0, 21105, "res == (ptrdiff_t)decoded_data_size" },
        { "maya_cube", 6101, -1, 0, 273, 0, 0, "arr_data" },
        { "maya_cube", 6101, -1, 0, 0, 0, 6793, "ufbxi_binary_parse_multivalue_array(uc, dst_type, arr_d..." },
        { "blender_279_default", 7401, -1, 0, 48, 0, 0, "vals" },
        { "blender_279_default", 7401, -1, 0, 0, 0, 209, "data" },
        { "blender_279_default", 7401, -1, 0, 825, 0, 0, "ufbxi_push_string_place_str(uc, &vals[i].s)" },
        { "maya_cube", 7401, -1, 0, 0, 0, 13713, "ufbxi_skip_bytes(uc, encoded_size)" },
        { "blender_279_default", 7401, -1, 0, 128, 0, 0, "ufbxi_binary_parse_node(uc, depth + 1, parse_state, &en..." },
        { "blender_279_default", 7401, -1, 0, 66, 0, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 19, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &token->str_data, &toke..." },
        { "blender_279_default", 6102, -1, 0, 13, 0, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "blender_279_default", 6102, -1, 0, 19, 0, 0, "ufbxi_ascii_push_token_char(uc, token, c)" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 11756, "end == token->str_data + token->str_len - 1" },
        { "maya_cone", 6102, -1, 0, 0, 0, 5192, "end == token->str_data + token->str_len - 1" },
        { "blender_279_default", 6102, -1, 0, 0, 0, 401, "c != '\\0'" },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 113, 0, "name" },
        { "blender_279_default", 6102, -1, 0, 16, 0, 0, "node" },
        { "blender_279_default", 6102, -1, 0, 1266, 0, 0, "arr" },
        { "blender_279_default", 6102, -1, 0, 0, 128, 0, "ufbxi_push_string_place_str(uc, &v->s)" },
        { "maya_cube", 6102, -1, 0, 0, 480, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 0, 272, 0, "v" },
        { "maya_interpolation_modes", 7502, -1, 0, 849, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 818, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4709, 0, 0, "v" },
        { "maya_auto_clamp", 7102, -1, 0, 816, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4800, 0, 0, "v" },
        { "blender_279_default", 6102, -1, 0, 4784, 0, 0, "v" },
        { "maya_cube", 7102, -1, 0, 0, 0, 8925, "ufbxi_ascii_accept(uc, UFBXI_ASCII_INT)" },
        { "maya_cube", 7102, -1, 0, 0, 0, 9156, "ufbxi_ascii_accept(uc, UFBXI_ASCII_NAME)" },
        { "maya_cube", 7102, -1, 0, 0, 0, 8945, "ufbxi_ascii_accept(uc, '}')" },
        { "blender_279_default", 6102, -1, 0, 4785, 0, 0, "arr_data" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "node->vals" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_ascii_parse_node(uc, depth + 1, parse_state, &end..." },
        ...
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_ascii_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 7401, -1, 0, 128, 0, 0, "ufbxi_binary_parse_node(uc, 0, state, p_end, buf, true)" },
        { "blender_279_default", 6102, -1, 0, 16, 0, 0, "ufbxi_ascii_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, &..." },
        { "blender_279_default", 7401, -1, 0, 96, 0, 0, "ufbxi_binary_parse_node(uc, 0, UFBXI_PARSE_ROOT, &end, ..." },
        { "blender_279_default", 6102, -1, 0, 18, 0, 0, "ufbxi_grow_array(&uc->ator_tmp, &uc->top_nodes, &uc->to..." },
        { "blender_279_default", 6102, -1, 0, 4656, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp, &en..." },
        { "blender_279_default", 6102, -1, 0, 4666, 0, 0, "node->children" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_parse_toplevel_child_imp(uc, state, &uc->tmp_pars..." },
        { "blender_279_default", 6102, -1, 0, 1, 0, 0, "ufbxi_push_string_imp(uc, str->data, str->length, false..." },
        { "blender_279_default", 6102, -1, 0, 7, 0, 0, "ufbxi_map_grow(&uc->prop_type_map, ufbxi_prop_type_name..." },
        { "blender_279_default", 6102, -1, 0, 9, 0, 0, "pooled" },
        { "blender_279_default", 6102, -1, 0, 0, 1, 0, "defs" },
        { "blender_279_default", 6102, -1, 0, 0, 3, 0, "defs->props" },
        { "blender_279_default", 6102, -1, 0, 0, 96, 0, "ufbxi_push_string_place_str(uc, &prop->name)" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_push_string_place_str(uc, &prop->value_str)" },
        ...
        { "blender_279_default", 6102, -1, 0, 32, 0, 0, "ufbxi_parse_toplevel_child(uc, &child)" },
        ...
        { "blender_279_default", 6102, -1, 0, 0, 409, 0, "dst->props" },
        ...
        { "blender_279_default", 6102, -1, 0, 80, 0, 0, "ufbxi_parse_toplevel_child(uc, &object)" },
        { "blender_279_default", 7401, -1, 0, 395, 0, 0, "tmpl" },
        { "blender_279_default", 7401, -1, 0, 480, 0, 0, "ufbxi_read_properties(uc, props, &tmpl->props, &uc->tmp..." },
        { "blender_279_default", 7401, -1, 0, 859, 0, 0, "uc->templates" },
        { "blender_279_default", 6102, -1, 0, 1382, 0, 0, "mesh" },
        { "maya_cube", 7102, -1, 0, 0, 0, 8909, "vertices && indices" },
        { "blender_279_default", 7401, -1, 0, 0, 323, 0, "edges" },
        { "blender_279_default", 6102, -1, 0, 0, 370, 0, "mesh->faces" },
        { "maya_cube", 6101, -1, 0, 488, 0, 0, "binormals" },
        { "maya_cube", 6101, -1, 0, 489, 0, 0, "tangents" },
        { "blender_282_suzanne", 7401, -1, 0, 0, 205, 0, "mesh->uv_sets.data" },
        { "maya_color_sets", 6101, -1, 0, 0, 185, 0, "mesh->color_sets.data" },
        { "blender_279_default", 6102, -1, 0, 4603, 0, 0, "material" },
        { "blender_279_default", 6102, -1, 0, 0, 410, 0, "ufbxi_merge_properties(uc, &material->props, material->..." },
        ...
        { "blender_279_default", 7401, -1, 0, 898, 0, 0, "attr" },
        { "maya_cube", 7101, -1, 0, 809, 0, 0, "layer" },
        { "maya_interpolation_modes", 7501, -1, 0, 859, 0, 0, "curve" },
        { "maya_interpolation_modes", 7502, -1, 0, 0, 0, 13315, "times = ufbxi_find_array(node, ufbxi_KeyTime, 'l')" },
        { "maya_interpolation_modes", 7501, -1, 0, 0, 258, 0, "keys" },
        { "maya_interpolation_modes", 7501, -1, 0, 912, 0, 0, "prop" },
        { "maya_cube", 7101, -1, 0, 0, 248, 0, "ufbxi_push_string_place_str(uc, type)" },
        { "blender_279_default", 6102, -1, 0, 0, 147, 0, "ufbxi_push_string_place_str(uc, name)" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, -1, 0, 0, 147, 0, "ufbxi_split_type_and_name(uc, type_and_name, &type_str,..." },
        { "blender_279_default", 7401, -1, 0, 896, 0, 0, "ufbxi_read_properties(uc, node, &object.props, &uc->tmp..." },
        ...
        { "blender_279_default", 6102, -1, 0, 4603, 0, 0, "ufbxi_read_material(uc, node, &object)" },
        { "blender_279_default", 7401, -1, 0, 898, 0, 0, "ufbxi_read_node_attribute(uc, node, &object)" },
        { "maya_cube", 7101, -1, 0, 809, 0, 0, "ufbxi_read_animation_layer(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, -1, 0, 859, 0, 0, "ufbxi_read_animation_curve(uc, node, &object)" },
        { "maya_interpolation_modes", 7501, -1, 0, 912, 0, 0, "ufbxi_read_animation_curve_node(uc, node, &object)" },
        { "blender_279_default", 6102, -1, 0, 5249, 0, 0, "curve" },
        ...
        { "blender_279_default", 6102, -1, 0, 5296, 0, 0, "prop" },
        { "blender_279_default", 6102, -1, 0, 5297, 0, 0, "ufbxi_add_connection(uc, layer_id, id, name)" },
        { "blender_279_default", 6102, -1, 0, 5298, 0, 0, "ufbxi_add_connection(uc, node_id, id, name)" },
        { "blender_279_default", 6102, -1, 0, 5248, 0, 0, "ufbxi_read_take_anim_channel(uc, channel_nodes[i], id, ..." },
        { "blender_279_default", 6102, -1, 0, 5248, 0, 0, "ufbxi_read_take_prop_channel(uc, child, node_id, layer_..." },
        { "blender_279_default", 6102, -1, 0, 5220, 0, 0, "layer" },
        ...
        { "blender_279_default", 6102, -1, 0, 4752, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "blender_279_default", 6102, -1, 0, 5248, 0, 0, "ufbxi_read_take(uc, node)" },
        { "blender_279_default", 7401, -1, 0, 1220, 0, 0, "uc->attributes" },
        { "blender_279_default", 6102, -1, 0, 4672, 0, 0, "ufbxi_parse_toplevel_child(uc, &node)" },
        { "maya_interpolation_modes", 7502, -1, 0, 0, 0, 17393, "ufbxi_get_val_at(node, 3, 'C', (char**)&prop)" },
        { "blender_279_default", 6102, -1, 0, 4673, 0, 0, "ufbxi_add_connection(uc, parent_id, child_id, prop)" },
        { "blender_279_default", 6102, -1, 0, 14, 0, 0, "model" },
        { "blender_279_default", 6102, -1, 0, 16, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_FBXHeaderExtension)" },
        { "blender_279_default", 6102, -1, 0, 32, 0, 0, "ufbxi_read_header_extension(uc)" },
        { "blender_279_default", 7401, -1, 0, 128, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Documents)" },
        ...
        { "blender_279_default", 6102, -1, 0, 80, 0, 0, "ufbxi_read_definitions(uc)" },
        { "blender_279_default", 6102, -1, 0, 88, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Objects)" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_read_objects(uc)" },
        ...
        { "blender_279_default", 6102, -1, 0, 4680, 0, 0, "ufbxi_parse_toplevel(uc, ufbxi_Takes)" },
        { "blender_279_default", 6102, -1, 0, 4752, 0, 0, "ufbxi_read_takes(uc)" },
        { "blender_279_default", 6102, -1, 0, 0, 464, 0, "arr->data" },
        { "blender_279_default", 6102, -1, 0, 0, 474, 0, "node->children.data" },
        { "maya_anim_light", 7501, -1, 0, 905, 0, 0, "ufbxi_merge_properties(uc, props, attr->defaults, props..." },
        { "blender_279_default", 7401, -1, 0, 1245, 0, 0, "ufbxi_merge_properties(uc, props, props->defaults, prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 470, 0, "ufbxi_merge_properties(uc, props, props, attr, &uc->res..." },
        { "blender_279_default", 6102, -1, 0, 0, 461, 0, "ufbxi_retain_array(uc, sizeof(ufbx_model), &uc->scene.m..." },
        { "blender_279_default", 6102, -1, 0, 0, 462, 0, "ufbxi_retain_array(uc, sizeof(ufbx_mesh), &uc->scene.me..." },
        { "blender_279_default", 6102, -1, 0, 0, 463, 0, "ufbxi_retain_array(uc, sizeof(ufbx_material), &uc->scen..." },
        { "blender_279_default", 6102, -1, 0, 0, 464, 0, "ufbxi_retain_array(uc, sizeof(ufbx_light), &uc->scene.l..." },
        { "blender_279_default", 6102, -1, 0, 0, 465, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_layer), &uc->sc..." },
        { "blender_279_default", 6102, -1, 0, 0, 466, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_prop), &uc->sce..." },
        { "blender_279_default", 6102, -1, 0, 0, 467, 0, "ufbxi_retain_array(uc, sizeof(ufbx_anim_curve), &uc->sc..." },
        { "blender_279_default", 6102, -1, 0, 5305, 0, 0, "conns" },
        { "blender_279_default", 7401, -1, 0, 1244, 0, 0, "uc->geometries" },
        { "blender_279_default", 6102, -1, 0, 0, 468, 0, "zero_indices && consecutive_indices" },
        { "blender_279_default", 7401, -1, 0, 0, 348, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 470, 0, "ufbxi_merge_attribute_properties(uc, &parent.node->prop..." },
        { "blender_279_default", 6102, -1, 0, 0, 471, 0, "layer->props.data" },
        { "blender_279_default", 6102, -1, 0, 0, 472, 0, "mesh->materials.data" },
        { "blender_279_default", 6102, -1, 0, 0, 473, 0, "nodes" },
        { "blender_279_default", 6102, -1, 0, 0, 474, 0, "ufbxi_collect_nodes(uc, sizeof(ufbx_model), &nodes, uc-..." },
        { "blender_279_default", 6102, -1, 0, 1, 0, 0, "ufbxi_load_strings(uc)" },
        { "blender_279_default", 6102, -1, 0, 7, 0, 0, "ufbxi_load_maps(uc)" },
        { "blender_279_default", 6102, -1, 0, 11, 0, 0, "ufbxi_load_default_props(uc)" },
        { "blender_279_default", 6102, -1, 0, 13, 0, 0, "ufbxi_begin_parse(uc)" },
        { "blender_279_default", 6102, -1, 0, 112, 0, 0, "ufbxi_read_root(uc)" },
