...
- Added warning/error when loading unsupported FBX versions (<3000 or
>7700)
...
Fixed ufbx_evaluate_curve() to return keyframe values at exat keyframe
...
Fixed typos and some material properties:
- inverted d for .mtl
