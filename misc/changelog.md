...
- Support for legacy FBX meshes without explicit node type
- Support for more legacy animation keyframe encodings
- Support for quoted names in legacy FBX files
