...
clang++ -coverage -c -g -std=c++11 -DNDEBUG -DUFBX_VOID_ASSERT -DUFBX_DEV=1 -DUFBX_REGRESSION=1 -DUFBXT_THREADS=1 -x c++ ufbx.c -o build/ufbx-cov.o
clang -lm -coverage -g -std=gnu99 -DNDEBUG -DUFBX_VOID_ASSERT -DUFBX_DEV=1 -DUFBX_REGRESSION=1 -DUFBXT_THREADS=1 -pthread build/ufbx-cov.o test/runner.c -o build/cov-runner
